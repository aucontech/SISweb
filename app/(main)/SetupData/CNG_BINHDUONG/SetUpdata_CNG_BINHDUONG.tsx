...
export default function SetUpdata_CNG_BINHDUONG() {
            ...
            ws.current.onmessage = (evt) => {
                ...
                if (dataReceived.update !== null) {
                    ...
                    const stateMap: StateMap = {
                        ...
                        EVC_01_Volume_at_Base_Conditions: setEVC_01_Volume_at_Base_Conditions,
                        ...
                        EVC_02_Volume_at_Base_Conditions: setEVC_02_Volume_at_Base_Conditions,
                        
                        EVC_02_Volume_at_Measurement_Conditions: setEVC_02_Volume_at_Measurement_Conditions,
                        EVC_02_Flow_at_Base_Conditions: setEVC_02_Flow_at_Base_Conditions,

                        EVC_02_Flow_at_Measurement_Conditions: setEVC_02_Flow_at_Measurement_Conditions,
    ...
    const fetchData = async () => {
        try {
            ...
            const EVC_01_Volume_at_Base_Conditions_High = res.data.find((item: any) => item.key === "EVC_01_Volume_at_Base_Conditions_High");
            setEVC_01_Volume_at_Base_Conditions_High(EVC_01_Volume_at_Base_Conditions_High?.value || null);
            const EVC_01_Volume_at_Base_Conditions_Low = res.data.find((item: any) => item.key === "EVC_01_Volume_at_Base_Conditions_Low");
            setEVC_01_Volume_at_Base_Conditions_Low(EVC_01_Volume_at_Base_Conditions_Low?.value || null);
            const EVC_01_Volume_at_Base_Conditions_Maintain = res.data.find(
                (item: any) => item.key === "EVC_01_Volume_at_Base_Conditions_Maintain"
            );
            ...
            const EVC_02_Volume_at_Measurement_Conditions_High = res.data.find((item: any) => item.key === "EVC_02_Volume_at_Measurement_Conditions_High");
            setEVC_02_Volume_at_Measurement_Conditions_High(EVC_02_Volume_at_Measurement_Conditions_High?.value || null);
            const EVC_02_Volume_at_Measurement_Conditions_Low = res.data.find((item: any) => item.key === "EVC_02_Volume_at_Measurement_Conditions_Low");
            setEVC_02_Volume_at_Measurement_Conditions_Low(EVC_02_Volume_at_Measurement_Conditions_Low?.value || null);
            const EVC_02_Volume_at_Measurement_Conditions_Maintain = res.data.find(
                (item: any) => item.key === "EVC_02_Volume_at_Measurement_Conditions_Maintain"
            );


            const EVC_02_Flow_at_Base_Conditions_High = res.data.find((item: any) => item.key === "EVC_02_Flow_at_Base_Conditions_High");
            setEVC_02_Flow_at_Base_Conditions_High(EVC_02_Flow_at_Base_Conditions_High?.value || null);
            const EVC_02_Flow_at_Base_Conditions_Low = res.data.find((item: any) => item.key === "EVC_02_Flow_at_Base_Conditions_Low");
            setEVC_02_Flow_at_Base_Conditions_Low(EVC_02_Flow_at_Base_Conditions_Low?.value || null);
            const EVC_02_Flow_at_Base_Conditions_Maintain = res.data.find(
                (item: any) => item.key === "EVC_02_Flow_at_Base_Conditions_Maintain"
            );

            const EVC_02_Flow_at_Measurement_Conditions_High = res.data.find((item: any) => item.key === "EVC_02_Flow_at_Measurement_Conditions_High");
            setEVC_02_Flow_at_Measurement_Conditions_High(EVC_02_Flow_at_Measurement_Conditions_High?.value || null);
            const EVC_02_Flow_at_Measurement_Conditions_Low = res.data.find((item: any) => item.key === "EVC_02_Flow_at_Measurement_Conditions_Low");
            setEVC_02_Flow_at_Measurement_Conditions_Low(EVC_02_Flow_at_Measurement_Conditions_Low?.value || null);
            const EVC_02_Flow_at_Measurement_Conditions_Maintain = res.data.find(
                (item: any) => item.key === "EVC_02_Flow_at_Measurement_Conditions_Maintain"
            );
            ...
            const EVC_02_Volume_at_Base_Conditions_High = res.data.find((item: any) => item.key === "EVC_02_Volume_at_Base_Conditions_High");
            setEVC_02_Volume_at_Base_Conditions_High(EVC_02_Volume_at_Base_Conditions_High?.value || null);
            const EVC_02_Volume_at_Base_Conditions_Low = res.data.find((item: any) => item.key === "EVC_02_Volume_at_Base_Conditions_Low");
            setEVC_02_Volume_at_Base_Conditions_Low(EVC_02_Volume_at_Base_Conditions_Low?.value || null);
            const EVC_02_Volume_at_Base_Conditions_Maintain = res.data.find(
                (item: any) => item.key === "EVC_02_Volume_at_Base_Conditions_Maintain"
            );
 ...
 // =================================================================================================================== 
            setMaintainEVC_02_Volume_at_Base_Conditions(EVC_02_Volume_at_Base_Conditions_Maintain?.value || false);
            ...
            setMaintainEVC_02_Flow_at_Measurement_Conditions(EVC_02_Flow_at_Measurement_Conditions_Maintain?.value || false);


            setMaintainEVC_02_Flow_at_Base_Conditions(EVC_02_Flow_at_Base_Conditions_Maintain?.value || false);


            setMaintainEVC_02_Volume_at_Measurement_Conditions(EVC_02_Volume_at_Measurement_Conditions_Maintain?.value || false);
            ...
            setMaintainEVC_01_Volume_at_Base_Conditions(EVC_01_Volume_at_Base_Conditions_Maintain?.value || false);
...
const [maintainEVC_01_Remain_Battery_Service_Life, setMaintainEVC_01_Remain_Battery_Service_Life] = useState<boolean>(false);
    ...
    const ChangeMaintainEVC_01_Remain_Battery_Service_Life = async () => {
     ...
     // =================================================================================================================== 
          ...
          const [EVC_01_Volume_at_Base_Conditions, setEVC_01_Volume_at_Base_Conditions] = useState<string | null>(null);
          const [audioPlayingEVC_01_Volume_at_Base_Conditions, setAudioPlayingEVC_01_Volume_at_Base_Conditions] = useState(false);
          const [inputValueEVC_01_Volume_at_Base_Conditions, setInputValueEVC_01_Volume_at_Base_Conditions] = useState<any>();
          const [inputValue2EVC_01_Volume_at_Base_Conditions, setInputValue2EVC_01_Volume_at_Base_Conditions] = useState<any>();
          const [EVC_01_Volume_at_Base_Conditions_High, setEVC_01_Volume_at_Base_Conditions_High] = useState<number | null>(null);
          const [EVC_01_Volume_at_Base_Conditions_Low, setEVC_01_Volume_at_Base_Conditions_Low] = useState<number | null>(null);
          const [exceedThresholdEVC_01_Volume_at_Base_Conditions, setExceedThresholdEVC_01_Volume_at_Base_Conditions] = useState(false); // State để lưu trữ trạng thái vượt ngưỡng
          
          const [maintainEVC_01_Volume_at_Base_Conditions, setMaintainEVC_01_Volume_at_Base_Conditions] = useState<boolean>(false);
          
          
              useEffect(() => {
                  if (typeof EVC_01_Volume_at_Base_Conditions_High === 'string' && typeof EVC_01_Volume_at_Base_Conditions_Low === 'string' && EVC_01_Volume_at_Base_Conditions !== null && maintainEVC_01_Volume_at_Base_Conditions === false
                  ) {
                      const highValue = parseFloat(EVC_01_Volume_at_Base_Conditions_High);
                      const lowValue = parseFloat(EVC_01_Volume_at_Base_Conditions_Low);
                      const EVC_01_Volume_at_Base_ConditionsValue = parseFloat(EVC_01_Volume_at_Base_Conditions);
              
                      if (!isNaN(highValue) && !isNaN(lowValue) && !isNaN(EVC_01_Volume_at_Base_ConditionsValue)) {
                          if (highValue <= EVC_01_Volume_at_Base_ConditionsValue || EVC_01_Volume_at_Base_ConditionsValue <= lowValue) {
                              if (!audioPlayingEVC_01_Volume_at_Base_Conditions) {
                                  audioRef.current?.play();
                                  setAudioPlayingEVC_01_Volume_at_Base_Conditions(true);
                                  setExceedThresholdEVC_01_Volume_at_Base_Conditions(true);
                              }
                          } else {
                             setAudioPlayingEVC_01_Volume_at_Base_Conditions(false);
                             setExceedThresholdEVC_01_Volume_at_Base_Conditions(false);
                          }
                      } 
                  } 
              }, [EVC_01_Volume_at_Base_Conditions_High, EVC_01_Volume_at_Base_Conditions, audioPlayingEVC_01_Volume_at_Base_Conditions, EVC_01_Volume_at_Base_Conditions_Low,maintainEVC_01_Volume_at_Base_Conditions]);
              ...
              }, [audioPlayingEVC_01_Volume_at_Base_Conditions]);
          
              const handleInputChangeEVC_01_Volume_at_Base_Conditions = (event: any) => {
                  const newValue = event.target.value;
                  setInputValueEVC_01_Volume_at_Base_Conditions(newValue);
              };
          
              const handleInputChange2EVC_01_Volume_at_Base_Conditions = (event: any) => {
                  const newValue2 = event.target.value;
                  setInputValue2EVC_01_Volume_at_Base_Conditions(newValue2);
              };
              const ChangeMaintainEVC_01_Volume_at_Base_Conditions = async () => {
                  try {
                      const newValue = !maintainEVC_01_Volume_at_Base_Conditions;
                      await httpApi.post(
                          `/plugins/telemetry/DEVICE/${id_CNG_BinhDuong}/SERVER_SCOPE`,
                          { EVC_01_Volume_at_Base_Conditions_Maintain: newValue }
                      );
                      setMaintainEVC_01_Volume_at_Base_Conditions(newValue);
...
const [EVC_02_Volume_at_Base_Conditions, setEVC_02_Volume_at_Base_Conditions] = useState<string | null>(null);
const [audioPlayingEVC_02_Volume_at_Base_Conditions, setAudioPlayingEVC_02_Volume_at_Base_Conditions] = useState(false);
const [inputValueEVC_02_Volume_at_Base_Conditions, setInputValueEVC_02_Volume_at_Base_Conditions] = useState<any>();
const [inputValue2EVC_02_Volume_at_Base_Conditions, setInputValue2EVC_02_Volume_at_Base_Conditions] = useState<any>();
const [EVC_02_Volume_at_Base_Conditions_High, setEVC_02_Volume_at_Base_Conditions_High] = useState<number | null>(null);
const [EVC_02_Volume_at_Base_Conditions_Low, setEVC_02_Volume_at_Base_Conditions_Low] = useState<number | null>(null);
const [exceedThresholdEVC_02_Volume_at_Base_Conditions, setExceedThresholdEVC_02_Volume_at_Base_Conditions] = useState(false); // State để lưu trữ trạng thái vượt ngưỡng

const [maintainEVC_02_Volume_at_Base_Conditions, setMaintainEVC_02_Volume_at_Base_Conditions] = useState<boolean>(false);


    useEffect(() => {
        if (typeof EVC_02_Volume_at_Base_Conditions_High === 'string' && typeof EVC_02_Volume_at_Base_Conditions_Low === 'string' && EVC_02_Volume_at_Base_Conditions !== null && maintainEVC_02_Volume_at_Base_Conditions === false
        ) {
            const highValue = parseFloat(EVC_02_Volume_at_Base_Conditions_High);
            const lowValue = parseFloat(EVC_02_Volume_at_Base_Conditions_Low);
            const EVC_02_Volume_at_Base_ConditionsValue = parseFloat(EVC_02_Volume_at_Base_Conditions);
    
            if (!isNaN(highValue) && !isNaN(lowValue) && !isNaN(EVC_02_Volume_at_Base_ConditionsValue)) {
                if (highValue <= EVC_02_Volume_at_Base_ConditionsValue || EVC_02_Volume_at_Base_ConditionsValue <= lowValue) {
                    if (!audioPlayingEVC_02_Volume_at_Base_Conditions) {
                        audioRef.current?.play();
                        setAudioPlayingEVC_02_Volume_at_Base_Conditions(true);
                        setExceedThresholdEVC_02_Volume_at_Base_Conditions(true);
                    }
                } else {
                   setAudioPlayingEVC_02_Volume_at_Base_Conditions(false);
                   setExceedThresholdEVC_02_Volume_at_Base_Conditions(false);
                }
            } 
        } 
    }, [EVC_02_Volume_at_Base_Conditions_High, EVC_02_Volume_at_Base_Conditions, audioPlayingEVC_02_Volume_at_Base_Conditions, EVC_02_Volume_at_Base_Conditions_Low,maintainEVC_02_Volume_at_Base_Conditions]);
    ...
    }, [audioPlayingEVC_02_Volume_at_Base_Conditions]);

    const handleInputChangeEVC_02_Volume_at_Base_Conditions = (event: any) => {
        const newValue = event.target.value;
        setInputValueEVC_02_Volume_at_Base_Conditions(newValue);
    };

    const handleInputChange2EVC_02_Volume_at_Base_Conditions = (event: any) => {
        const newValue2 = event.target.value;
        setInputValue2EVC_02_Volume_at_Base_Conditions(newValue2);
    };
    const ChangeMaintainEVC_02_Volume_at_Base_Conditions = async () => {
        try {
            const newValue = !maintainEVC_02_Volume_at_Base_Conditions;
            await httpApi.post(
                `/plugins/telemetry/DEVICE/${id_CNG_BinhDuong}/SERVER_SCOPE`,
                { EVC_02_Volume_at_Base_Conditions_Maintain: newValue }
            );
            setMaintainEVC_02_Volume_at_Base_Conditions(newValue);
...
const [EVC_02_Volume_at_Measurement_Conditions, setEVC_02_Volume_at_Measurement_Conditions] = useState<string | null>(null);
const [audioPlayingEVC_02_Volume_at_Measurement_Conditions, setAudioPlayingEVC_02_Volume_at_Measurement_Conditions] = useState(false);
const [inputValueEVC_02_Volume_at_Measurement_Conditions, setInputValueEVC_02_Volume_at_Measurement_Conditions] = useState<any>();
const [inputValue2EVC_02_Volume_at_Measurement_Conditions, setInputValue2EVC_02_Volume_at_Measurement_Conditions] = useState<any>();
const [EVC_02_Volume_at_Measurement_Conditions_High, setEVC_02_Volume_at_Measurement_Conditions_High] = useState<number | null>(null);
const [EVC_02_Volume_at_Measurement_Conditions_Low, setEVC_02_Volume_at_Measurement_Conditions_Low] = useState<number | null>(null);
const [exceedThresholdEVC_02_Volume_at_Measurement_Conditions, setExceedThresholdEVC_02_Volume_at_Measurement_Conditions] = useState(false); // State để lưu trữ trạng thái vượt ngưỡng

const [maintainEVC_02_Volume_at_Measurement_Conditions, setMaintainEVC_02_Volume_at_Measurement_Conditions] = useState<boolean>(false);


    useEffect(() => {
        if (typeof EVC_02_Volume_at_Measurement_Conditions_High === 'string' && typeof EVC_02_Volume_at_Measurement_Conditions_Low === 'string' && EVC_02_Volume_at_Measurement_Conditions !== null && maintainEVC_02_Volume_at_Measurement_Conditions === false
        ) {
            const highValue = parseFloat(EVC_02_Volume_at_Measurement_Conditions_High);
            const lowValue = parseFloat(EVC_02_Volume_at_Measurement_Conditions_Low);
            const EVC_02_Volume_at_Measurement_ConditionsValue = parseFloat(EVC_02_Volume_at_Measurement_Conditions);
    
            if (!isNaN(highValue) && !isNaN(lowValue) && !isNaN(EVC_02_Volume_at_Measurement_ConditionsValue)) {
                if (highValue <= EVC_02_Volume_at_Measurement_ConditionsValue || EVC_02_Volume_at_Measurement_ConditionsValue <= lowValue) {
                    if (!audioPlayingEVC_02_Volume_at_Measurement_Conditions) {
                        audioRef.current?.play();
                        setAudioPlayingEVC_02_Volume_at_Measurement_Conditions(true);
                        setExceedThresholdEVC_02_Volume_at_Measurement_Conditions(true);
                    }
                } else {
                   setAudioPlayingEVC_02_Volume_at_Measurement_Conditions(false);
                   setExceedThresholdEVC_02_Volume_at_Measurement_Conditions(false);
                }
            } 
        } 
    }, [EVC_02_Volume_at_Measurement_Conditions_High, EVC_02_Volume_at_Measurement_Conditions, audioPlayingEVC_02_Volume_at_Measurement_Conditions, EVC_02_Volume_at_Measurement_Conditions_Low,maintainEVC_02_Volume_at_Measurement_Conditions]);
    ...
    }, [audioPlayingEVC_02_Volume_at_Measurement_Conditions]);

    const handleInputChangeEVC_02_Volume_at_Measurement_Conditions = (event: any) => {
        const newValue = event.target.value;
        setInputValueEVC_02_Volume_at_Measurement_Conditions(newValue);
    };

    const handleInputChange2EVC_02_Volume_at_Measurement_Conditions = (event: any) => {
        const newValue2 = event.target.value;
        setInputValue2EVC_02_Volume_at_Measurement_Conditions(newValue2);
    };
    const ChangeMaintainEVC_02_Volume_at_Measurement_Conditions = async () => {
        try {
            const newValue = !maintainEVC_02_Volume_at_Measurement_Conditions;
            await httpApi.post(
                `/plugins/telemetry/DEVICE/${id_CNG_BinhDuong}/SERVER_SCOPE`,
                { EVC_02_Volume_at_Measurement_Conditions_Maintain: newValue }
            );
            setMaintainEVC_02_Volume_at_Measurement_Conditions(newValue);
...
const [EVC_02_Flow_at_Base_Conditions, setEVC_02_Flow_at_Base_Conditions] = useState<string | null>(null);
const [audioPlayingEVC_02_Flow_at_Base_Conditions, setAudioPlayingEVC_02_Flow_at_Base_Conditions] = useState(false);
const [inputValueEVC_02_Flow_at_Base_Conditions, setInputValueEVC_02_Flow_at_Base_Conditions] = useState<any>();
const [inputValue2EVC_02_Flow_at_Base_Conditions, setInputValue2EVC_02_Flow_at_Base_Conditions] = useState<any>();
const [EVC_02_Flow_at_Base_Conditions_High, setEVC_02_Flow_at_Base_Conditions_High] = useState<number | null>(null);
const [EVC_02_Flow_at_Base_Conditions_Low, setEVC_02_Flow_at_Base_Conditions_Low] = useState<number | null>(null);
const [exceedThresholdEVC_02_Flow_at_Base_Conditions, setExceedThresholdEVC_02_Flow_at_Base_Conditions] = useState(false); // State để lưu trữ trạng thái vượt ngưỡng

const [maintainEVC_02_Flow_at_Base_Conditions, setMaintainEVC_02_Flow_at_Base_Conditions] = useState<boolean>(false);


useEffect(() => {
    if (typeof EVC_02_Flow_at_Base_Conditions_High === 'string' && typeof EVC_02_Flow_at_Base_Conditions_Low === 'string' && EVC_02_Flow_at_Base_Conditions !== null && maintainEVC_02_Flow_at_Base_Conditions === false
    ) {
        const highValue = parseFloat(EVC_02_Flow_at_Base_Conditions_High);
        const lowValue = parseFloat(EVC_02_Flow_at_Base_Conditions_Low);
        const EVC_02_Flow_at_Base_ConditionsValue = parseFloat(EVC_02_Flow_at_Base_Conditions);

        if (!isNaN(highValue) && !isNaN(lowValue) && !isNaN(EVC_02_Flow_at_Base_ConditionsValue)) {
            if (highValue <= EVC_02_Flow_at_Base_ConditionsValue || EVC_02_Flow_at_Base_ConditionsValue <= lowValue) {
                if (!audioPlayingEVC_02_Flow_at_Base_Conditions) {
                    audioRef.current?.play();
                    setAudioPlayingEVC_02_Flow_at_Base_Conditions(true);
                    setExceedThresholdEVC_02_Flow_at_Base_Conditions(true);
                }
            } else {
               setAudioPlayingEVC_02_Flow_at_Base_Conditions(false);
               setExceedThresholdEVC_02_Flow_at_Base_Conditions(false);
            }
        } 
    } 
}, [EVC_02_Flow_at_Base_Conditions_High, EVC_02_Flow_at_Base_Conditions, audioPlayingEVC_02_Flow_at_Base_Conditions, EVC_02_Flow_at_Base_Conditions_Low,maintainEVC_02_Flow_at_Base_Conditions]);
...
}, [audioPlayingEVC_02_Flow_at_Base_Conditions]);

const handleInputChangeEVC_02_Flow_at_Base_Conditions = (event: any) => {
    const newValue = event.target.value;
    setInputValueEVC_02_Flow_at_Base_Conditions(newValue);
};

const handleInputChange2EVC_02_Flow_at_Base_Conditions = (event: any) => {
    const newValue2 = event.target.value;
    setInputValue2EVC_02_Flow_at_Base_Conditions(newValue2);
};
const ChangeMaintainEVC_02_Flow_at_Base_Conditions = async () => {
    try {
        const newValue = !maintainEVC_02_Flow_at_Base_Conditions;
        await httpApi.post(
            `/plugins/telemetry/DEVICE/${id_CNG_BinhDuong}/SERVER_SCOPE`,
            { EVC_02_Flow_at_Base_Conditions_Maintain: newValue }
        );
        setMaintainEVC_02_Flow_at_Base_Conditions(newValue);
...
// =================================================================================================================== 
        ...
        const [EVC_02_Flow_at_Measurement_Conditions, setEVC_02_Flow_at_Measurement_Conditions] = useState<string | null>(null);
        const [audioPlayingEVC_02_Flow_at_Measurement_Conditions, setAudioPlayingEVC_02_Flow_at_Measurement_Conditions] = useState(false);
        const [inputValueEVC_02_Flow_at_Measurement_Conditions, setInputValueEVC_02_Flow_at_Measurement_Conditions] = useState<any>();
        const [inputValue2EVC_02_Flow_at_Measurement_Conditions, setInputValue2EVC_02_Flow_at_Measurement_Conditions] = useState<any>();
        const [EVC_02_Flow_at_Measurement_Conditions_High, setEVC_02_Flow_at_Measurement_Conditions_High] = useState<number | null>(null);
        const [EVC_02_Flow_at_Measurement_Conditions_Low, setEVC_02_Flow_at_Measurement_Conditions_Low] = useState<number | null>(null);
        const [exceedThresholdEVC_02_Flow_at_Measurement_Conditions, setExceedThresholdEVC_02_Flow_at_Measurement_Conditions] = useState(false); // State để lưu trữ trạng thái vượt ngưỡng
        
        const [maintainEVC_02_Flow_at_Measurement_Conditions, setMaintainEVC_02_Flow_at_Measurement_Conditions] = useState<boolean>(false);
        
        
            useEffect(() => {
                if (typeof EVC_02_Flow_at_Measurement_Conditions_High === 'string' && typeof EVC_02_Flow_at_Measurement_Conditions_Low === 'string' && EVC_02_Flow_at_Measurement_Conditions !== null && maintainEVC_02_Flow_at_Measurement_Conditions === false
                ) {
                    const highValue = parseFloat(EVC_02_Flow_at_Measurement_Conditions_High);
                    const lowValue = parseFloat(EVC_02_Flow_at_Measurement_Conditions_Low);
                    const EVC_02_Flow_at_Measurement_ConditionsValue = parseFloat(EVC_02_Flow_at_Measurement_Conditions);
            
                    if (!isNaN(highValue) && !isNaN(lowValue) && !isNaN(EVC_02_Flow_at_Measurement_ConditionsValue)) {
                        if (highValue <= EVC_02_Flow_at_Measurement_ConditionsValue || EVC_02_Flow_at_Measurement_ConditionsValue <= lowValue) {
                            if (!audioPlayingEVC_02_Flow_at_Measurement_Conditions) {
                                audioRef.current?.play();
                                setAudioPlayingEVC_02_Flow_at_Measurement_Conditions(true);
                                setExceedThresholdEVC_02_Flow_at_Measurement_Conditions(true);
                            }
                        } else {
                           setAudioPlayingEVC_02_Flow_at_Measurement_Conditions(false);
                           setExceedThresholdEVC_02_Flow_at_Measurement_Conditions(false);
                        }
                    } 
                } 
            }, [EVC_02_Flow_at_Measurement_Conditions_High, EVC_02_Flow_at_Measurement_Conditions, audioPlayingEVC_02_Flow_at_Measurement_Conditions, EVC_02_Flow_at_Measurement_Conditions_Low,maintainEVC_02_Flow_at_Measurement_Conditions]);
            ...
            }, [audioPlayingEVC_02_Flow_at_Measurement_Conditions]);
        
            const handleInputChangeEVC_02_Flow_at_Measurement_Conditions = (event: any) => {
                const newValue = event.target.value;
                setInputValueEVC_02_Flow_at_Measurement_Conditions(newValue);
            };
        
            const handleInputChange2EVC_02_Flow_at_Measurement_Conditions = (event: any) => {
                const newValue2 = event.target.value;
                setInputValue2EVC_02_Flow_at_Measurement_Conditions(newValue2);
            };
            const ChangeMaintainEVC_02_Flow_at_Measurement_Conditions = async () => {
                try {
                    const newValue = !maintainEVC_02_Flow_at_Measurement_Conditions;
                    await httpApi.post(
                        `/plugins/telemetry/DEVICE/${id_CNG_BinhDuong}/SERVER_SCOPE`,
                        { EVC_02_Flow_at_Measurement_Conditions_Maintain: newValue }
                    );
                    setMaintainEVC_02_Flow_at_Measurement_Conditions(newValue);
 ...
 // =================================================================================================================== 
        ...
        try {
            await httpApi.post(
...

                {
                    ...
                    EVC_01_Volume_at_Base_Conditions_High: inputValueEVC_01_Volume_at_Base_Conditions,EVC_01_Volume_at_Base_Conditions_Low:inputValue2EVC_01_Volume_at_Base_Conditions,
                    ...
                    EVC_02_Volume_at_Base_Conditions_High: inputValueEVC_02_Volume_at_Base_Conditions,EVC_02_Volume_at_Base_Conditions_Low:inputValue2EVC_02_Volume_at_Base_Conditions,

                    EVC_02_Volume_at_Measurement_Conditions_High: inputValueEVC_02_Volume_at_Measurement_Conditions,EVC_02_Volume_at_Measurement_Conditions_Low:inputValue2EVC_02_Volume_at_Measurement_Conditions,
                    EVC_02_Flow_at_Base_Conditions_High: inputValueEVC_02_Flow_at_Base_Conditions,EVC_02_Flow_at_Base_Conditions_Low:inputValue2EVC_02_Flow_at_Base_Conditions,


                    EVC_02_Flow_at_Measurement_Conditions_High: inputValueEVC_02_Flow_at_Measurement_Conditions,EVC_02_Flow_at_Measurement_Conditions_Low:inputValue2EVC_02_Flow_at_Measurement_Conditions,
            ...
            setEVC_01_Volume_at_Base_Conditions_High(inputValueEVC_01_Volume_at_Base_Conditions);
            setEVC_01_Volume_at_Base_Conditions_Low(inputValue2EVC_01_Volume_at_Base_Conditions);
            ...
            setEVC_02_Volume_at_Base_Conditions_High(inputValueEVC_02_Volume_at_Base_Conditions);
            setEVC_02_Volume_at_Base_Conditions_Low(inputValue2EVC_02_Volume_at_Base_Conditions);



            setEVC_02_Flow_at_Measurement_Conditions_High(inputValueEVC_02_Flow_at_Measurement_Conditions);
            setEVC_02_Flow_at_Measurement_Conditions_Low(inputValue2EVC_02_Flow_at_Measurement_Conditions);
    ...
    useEffect(() => {
        ...
        setInputValueEVC_01_Volume_at_Base_Conditions(EVC_01_Volume_at_Base_Conditions_High); 
        setInputValue2EVC_01_Volume_at_Base_Conditions(EVC_01_Volume_at_Base_Conditions_Low); 
        ...
        setInputValueEVC_02_Volume_at_Base_Conditions(EVC_02_Volume_at_Base_Conditions_High); 
        setInputValue2EVC_02_Volume_at_Base_Conditions(EVC_02_Volume_at_Base_Conditions_Low); 


        setInputValueEVC_02_Volume_at_Measurement_Conditions(EVC_02_Volume_at_Measurement_Conditions_High); 
        setInputValue2EVC_02_Volume_at_Measurement_Conditions(EVC_02_Volume_at_Measurement_Conditions_Low); 

        setInputValueEVC_02_Flow_at_Base_Conditions(EVC_02_Flow_at_Base_Conditions_High); 
        setInputValue2EVC_02_Flow_at_Base_Conditions(EVC_02_Flow_at_Base_Conditions_Low); 


        setInputValueEVC_02_Flow_at_Measurement_Conditions(EVC_02_Flow_at_Measurement_Conditions_High); 
        setInputValue2EVC_02_Flow_at_Measurement_Conditions(EVC_02_Flow_at_Measurement_Conditions_Low); 
        ...
        EVC_01_Volume_at_Measurement_Condition_High,EVC_01_Volume_at_Measurement_Condition_Low,
         EVC_01_Flow_at_Base_Condition_High,EVC_01_Flow_at_Base_Condition_Low ,
          EVC_01_Volume_at_Base_Conditions_High,EVC_01_Volume_at_Base_Conditions_Low,
          ...
          EVC_01_Vm_of_Current_Day_High,EVC_01_Vm_of_Current_Day_Low ,
           ...
           EVC_02_Volume_at_Base_Conditions_High,EVC_02_Volume_at_Base_Conditions_Low,

           EVC_02_Flow_at_Base_Conditions_High,EVC_02_Flow_at_Base_Conditions_Low,
           EVC_02_Volume_at_Measurement_Conditions_High,EVC_02_Volume_at_Measurement_Conditions_Low,


           EVC_02_Flow_at_Measurement_Conditions_High,EVC_02_Flow_at_Measurement_Conditions_Low,
    ...
    const combineCss = {
        ...
        CSSEVC_01_Volume_at_Base_Conditions : {
            color:exceedThresholdEVC_01_Volume_at_Base_Conditions && !maintainEVC_01_Volume_at_Base_Conditions
            ? "#ff5656"
            : maintainEVC_01_Volume_at_Base_Conditions
            ? "orange"
            : "" ,
            height:25,
            fontWeight:400,
        ...
        CSSEVC_02_Volume_at_Base_Conditions : {
            color:exceedThresholdEVC_02_Volume_at_Base_Conditions && !maintainEVC_02_Volume_at_Base_Conditions
            ? "#ff5656"
            : maintainEVC_02_Volume_at_Base_Conditions
            ? "orange"
            : "" ,
            height:25,
            fontWeight:400,
        ...
        CSSEVC_02_Volume_at_Measurement_Conditions : {
            color:exceedThresholdEVC_02_Volume_at_Measurement_Conditions && !maintainEVC_02_Volume_at_Measurement_Conditions
            ? "#ff5656"
            : maintainEVC_02_Volume_at_Measurement_Conditions
            ? "orange"
            : "" ,
            height:25,
            fontWeight:400,
        ...
        CSSEVC_02_Flow_at_Base_Conditions : {
            color:exceedThresholdEVC_02_Flow_at_Base_Conditions && !maintainEVC_02_Flow_at_Base_Conditions
            ? "#ff5656"
            : maintainEVC_02_Flow_at_Base_Conditions
            ? "orange"
            : "" ,
            height:25,
            fontWeight:400,
        ...
        CSSEVC_02_Flow_at_Measurement_Conditions : {
            color:exceedThresholdEVC_02_Flow_at_Measurement_Conditions && !maintainEVC_02_Flow_at_Measurement_Conditions
            ? "#ff5656"
            : maintainEVC_02_Flow_at_Measurement_Conditions
            ? "orange"
            : "" ,
            height:25,
            fontWeight:400,
        ...
        ></Checkbox>
           ...
           { timeUpdate: <span style={combineCss.CSSEVC_01_Volume_at_Base_Conditions} >{timeUpdate}</span>,
           name: <span style={combineCss.CSSEVC_01_Volume_at_Base_Conditions}> Volume at Base Condition</span> ,
  
           modbus: <span style={combineCss.CSSEVC_01_Volume_at_Base_Conditions}>40854	 </span> ,
  
          value: <span style={combineCss.CSSEVC_01_Volume_at_Base_Conditions} > {EVC_01_Volume_at_Base_Conditions}</span> , 
           high: <InputText style={combineCss.CSSEVC_01_Volume_at_Base_Conditions}   placeholder='High' step="0.1" type='number' value={inputValueEVC_01_Volume_at_Base_Conditions} onChange={handleInputChangeEVC_01_Volume_at_Base_Conditions} inputMode="decimal" />, 
           low:  <InputText style={combineCss.CSSEVC_01_Volume_at_Base_Conditions}   placeholder='Low' step="0.1" type='number' value={inputValue2EVC_01_Volume_at_Base_Conditions} onChange={handleInputChange2EVC_01_Volume_at_Base_Conditions} inputMode="decimal" />,
           update:  <button className='buttonUpdateSetData' onClick={confirmUpData} > Update </button>,
           Maintain:   <Checkbox
           style={{ marginRight: 20, }}
           onChange={ChangeMaintainEVC_01_Volume_at_Base_Conditions}
           checked={maintainEVC_01_Volume_at_Base_Conditions}
       ></Checkbox>
...
></Checkbox>
  ...
  { timeUpdate: <span style={combineCss.CSSEVC_02_Volume_at_Base_Conditions} >{timeUpdate}</span>,
  name: <span style={combineCss.CSSEVC_02_Volume_at_Base_Conditions}>Volume at Base Condition</span> ,

  modbus: <span style={combineCss.CSSEVC_02_Volume_at_Base_Conditions}>40854	 </span> ,

 value: <span style={combineCss.CSSEVC_02_Volume_at_Base_Conditions} > {EVC_02_Volume_at_Base_Conditions}</span> , 
  high: <InputText style={combineCss.CSSEVC_02_Volume_at_Base_Conditions}   placeholder='High' step="0.1" type='number' value={inputValueEVC_02_Volume_at_Base_Conditions} onChange={handleInputChangeEVC_02_Volume_at_Base_Conditions} inputMode="decimal" />, 
  low:  <InputText style={combineCss.CSSEVC_02_Volume_at_Base_Conditions}   placeholder='Low' step="0.1" type='number' value={inputValue2EVC_02_Volume_at_Base_Conditions} onChange={handleInputChange2EVC_02_Volume_at_Base_Conditions} inputMode="decimal" />,
  update:  <button className='buttonUpdateSetData' onClick={confirmUpData} > Update </button>,
  Maintain:   <Checkbox
  style={{ marginRight: 20, }}
  onChange={ChangeMaintainEVC_02_Volume_at_Base_Conditions}
  checked={maintainEVC_02_Volume_at_Base_Conditions}
></Checkbox>

 },

 { timeUpdate: <span style={combineCss.CSSEVC_02_Volume_at_Measurement_Conditions} >{timeUpdate}</span>,
   name: <span style={combineCss.CSSEVC_02_Volume_at_Measurement_Conditions}>Volume at Measurement Condition</span> ,

   modbus: <span style={combineCss.CSSEVC_02_Volume_at_Measurement_Conditions}>40856	 </span> ,

  value: <span style={combineCss.CSSEVC_02_Volume_at_Measurement_Conditions} > {EVC_02_Volume_at_Measurement_Conditions}</span> , 
   high: <InputText style={combineCss.CSSEVC_02_Volume_at_Measurement_Conditions}   placeholder='High' step="0.1" type='number' value={inputValueEVC_02_Volume_at_Measurement_Conditions} onChange={handleInputChangeEVC_02_Volume_at_Measurement_Conditions} inputMode="decimal" />, 
   low:  <InputText style={combineCss.CSSEVC_02_Volume_at_Measurement_Conditions}   placeholder='Low' step="0.1" type='number' value={inputValue2EVC_02_Volume_at_Measurement_Conditions} onChange={handleInputChange2EVC_02_Volume_at_Measurement_Conditions} inputMode="decimal" />,
   update:  <button className='buttonUpdateSetData' onClick={confirmUpData} > Update </button>,
   Maintain:   <Checkbox
   style={{ marginRight: 20, }}
   onChange={ChangeMaintainEVC_02_Volume_at_Measurement_Conditions}
   checked={maintainEVC_02_Volume_at_Measurement_Conditions}
></Checkbox>

  },


  { timeUpdate: <span style={combineCss.CSSEVC_02_Flow_at_Base_Conditions} >{timeUpdate}</span>,
  name: <span style={combineCss.CSSEVC_02_Flow_at_Base_Conditions}>Flow at Base Condition</span> ,

  modbus: <span style={combineCss.CSSEVC_02_Flow_at_Base_Conditions}>40858	 </span> ,

 value: <span style={combineCss.CSSEVC_02_Flow_at_Base_Conditions} > {EVC_02_Flow_at_Base_Conditions}</span> , 
  high: <InputText style={combineCss.CSSEVC_02_Flow_at_Base_Conditions}   placeholder='High' step="0.1" type='number' value={inputValueEVC_02_Flow_at_Base_Conditions} onChange={handleInputChangeEVC_02_Flow_at_Base_Conditions} inputMode="decimal" />, 
  low:  <InputText style={combineCss.CSSEVC_02_Flow_at_Base_Conditions}   placeholder='Low' step="0.1" type='number' value={inputValue2EVC_02_Flow_at_Base_Conditions} onChange={handleInputChange2EVC_02_Flow_at_Base_Conditions} inputMode="decimal" />,
  update:  <button className='buttonUpdateSetData' onClick={confirmUpData} > Update </button>,
  Maintain:   <Checkbox
  style={{ marginRight: 20, }}
  onChange={ChangeMaintainEVC_02_Flow_at_Base_Conditions}
  checked={maintainEVC_02_Flow_at_Base_Conditions}
></Checkbox>
 ...
 { timeUpdate: <span style={combineCss.CSSEVC_02_Flow_at_Measurement_Conditions} >{timeUpdate}</span>,
 name: <span style={combineCss.CSSEVC_02_Flow_at_Measurement_Conditions}>Flow at Measurement Condition</span> ,

 modbus: <span style={combineCss.CSSEVC_02_Flow_at_Measurement_Conditions}>40860	 </span> ,

value: <span style={combineCss.CSSEVC_02_Flow_at_Measurement_Conditions} > {EVC_02_Flow_at_Measurement_Conditions}</span> , 
 high: <InputText style={combineCss.CSSEVC_02_Flow_at_Measurement_Conditions}   placeholder='High' step="0.1" type='number' value={inputValueEVC_02_Flow_at_Measurement_Conditions} onChange={handleInputChangeEVC_02_Flow_at_Measurement_Conditions} inputMode="decimal" />, 
 low:  <InputText style={combineCss.CSSEVC_02_Flow_at_Measurement_Conditions}   placeholder='Low' step="0.1" type='number' value={inputValue2EVC_02_Flow_at_Measurement_Conditions} onChange={handleInputChange2EVC_02_Flow_at_Measurement_Conditions} inputMode="decimal" />,
 update:  <button className='buttonUpdateSetData' onClick={confirmUpData} > Update </button>,
 Maintain:   <Checkbox
 style={{ marginRight: 20, }}
 onChange={ChangeMaintainEVC_02_Flow_at_Measurement_Conditions}
 checked={maintainEVC_02_Flow_at_Measurement_Conditions}
></Checkbox>
...
></Checkbox>
          ...
          const PLC01 = [
            ...
            { timeUpdate: <span style={combineCss.CSSPIT_2006} >{timeUpdate}</span>,
            ...
            value: <span style={combineCss.CSSPIT_2006} > {PIT_2006}</span> , 
         ...
         ></Checkbox>
            ...
            { timeUpdate: <span style={combineCss.CSSPIT_2007} >{timeUpdate}</span>,
            ...
            value: <span style={combineCss.CSSPIT_2007} > {PIT_2007}</span> , 
         ...
         ></Checkbox>
            ...
            { timeUpdate: <span style={combineCss.CSSPT_2001} >{timeUpdate}</span>,
            ...
            value: <span style={combineCss.CSSPT_2001} > {PT_2001}</span> , 
         ...
         ></Checkbox>
            ...
            { timeUpdate: <span style={combineCss.CSSPT_2002} >{timeUpdate}</span>,
            ...
            value: <span style={combineCss.CSSPT_2002} > {PT_2002}</span> , 
         ...
         ></Checkbox>
            ...
            { timeUpdate: <span style={combineCss.CSSPT_2003} >{timeUpdate}</span>,
           ...
           value: <span style={combineCss.CSSPT_2003} > {PT_2003}</span> , 
        ...
        ></Checkbox>
           ...
           { timeUpdate: <span style={combineCss.CSSTT_2001} >{timeUpdate}</span>,
          ...
          value: <span style={combineCss.CSSTT_2001} > {TT_2001}</span> , 
       ...
       ></Checkbox>
         ...
         { timeUpdate: <span style={combineCss.CSSTT_2002} >{timeUpdate}</span>,
        ...
        value: <span style={combineCss.CSSTT_2002} > {TT_2002}</span> , 
    ...
    ></Checkbox>
       ...
       { timeUpdate: <span style={combineCss.CSSSDV_2001A} >{timeUpdate}</span>,
   ...
   ></Checkbox>
      ...
      { timeUpdate: <span style={combineCss.CSSSDV_2001B} >{timeUpdate}</span>,
  ...
  ></Checkbox>
     ...
     { timeUpdate: <span style={combineCss.CSSSDV_2002} >{timeUpdate}</span>,
...
{ timeUpdate: <span style={combineCss.CSSESD_2001} >{timeUpdate}</span>,
...
{ timeUpdate: <span style={combineCss.CSSSD_2001} >{timeUpdate}</span>,
...
{ timeUpdate: <span style={combineCss.CSSSD_2002} >{timeUpdate}</span>,
