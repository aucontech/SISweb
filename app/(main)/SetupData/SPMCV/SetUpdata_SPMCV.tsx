...
export default function SetUpdata_SPMCV() {
...
maintainPLC_Conn_STT === true;
  ...
  const mainCategoryFC = {
    EVC: <span  style={{display:'flex',textAlign:'center', justifyContent:'space-between'  }}> EVC-1701 -  Parameter & Configuration  <div style={{display:'flex' , textAlign:'center', alignItems:'center',}}>  
        <Checkbox
        disabled={TECH_OPER}
            style={{ marginRight: 5 }}
...
></Checkbox>
    ...
    const PLC = [

        {
         ...
         name: <span style={combineCss.CSSGD1}>Gas Detector GD-1701</span> ,
     ...
     ></Checkbox>
...

        {
         ...
         name: <span style={combineCss.CSSGD2}>Gas Detector GD-1702</span> ,
     ...
     ></Checkbox>
        ...
        name: <span style={combineCss.CSSPT1}>Input Pressure PT-1703</span> ,
    ...
    ></Checkbox>
       ...
       name: <span style={combineCss.CSSDI_ZSO_1}>SDV-1701 ZSO</span> ,
   ...
   ></Checkbox>
     ...
     name: <span style={combineCss.CSSDI_ZSC_1}>SDV-1701 ZSC</span> ,
...
name: <span style={combineCss.CSSDO_SV_01}>SDV-1701 SOLENOID</span> ,
...
high: <InputText disabled={TECHNIAN_AUTH} style={combineCss.CSSDO_SV_01}   placeholder='High' step="0.1" type='number' value={inputValuDO_SV_01} onChange={handleInputChangDO_BC_01} inputMode="decimal" />, 
...
></Checkbox>
    ...
    useEffect(() => {
      ...
      const ConfigurationName ={
        ...
        EVC_01_Battery_Expiration_Date: "EVC-1701 Battery Expiration Date",
        EVC_01_Battery_Installation_Date: "EVC-1701 Battery Installation Date",

        EVC_02_Battery_Expiration_Date: "EVC-1702 Battery Expiration Date",
        EVC_02_Battery_Installation_Date: "EVC-1702 Battery Installation Date"
    ...
    const Configuration = [
        {
            Name: <span style={combineCssAttribute.PCV}>{namePCV_PSV.control} (PCV-1701) (BarG)</span>,
        ...
        {
            Name: <span style={combineCssAttribute.PCV}>{namePCV_PSV.control} (PCV-1702) (BarG)</span>,
        ...
        {
            Name: <span style={combineCssAttribute.PCV}>{namePCV_PSV.safety} (PSV-1701) (BarG)</span>,
