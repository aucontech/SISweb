...
></Checkbox>
    ...
    const Configuration = [
        {
            Name: <span style={combineCssAttribute.PCV}>{namePCV_PSV.control} (PCV-3003) (BarG)</span>,
        ...
        {
            Name: <span style={combineCssAttribute.PCV}>{namePCV_PSV.control} (PCV-3004) (BarG)</span>,
            Value: (
                <InputText
                    style={combineCssAttribute.PCV}
                    placeholder="High"
