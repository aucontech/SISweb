...
import { id_SNG } from '../../data-table-device/ID-DEVICE/IdDevice';
...
export default function SetUpdata_SNG_PRU() {
            ...
            ws.current.onmessage = (evt) => {
                ...
                if (dataReceived.update !== null) {
                    ...
                    const valueStateMap: ValueStateMap = {
                        ...
                        Calorific_Calorimeter: setPLC_STTValue,
                    };
                    keys.forEach((key) => {
                        if (stateMap[key]) {
    ...
    const fetchData = async () => {
        try {
            const res = await httpApi.get(
                `/plugins/telemetry/DEVICE/${id_SNG}/values/attributes/SERVER_SCOPE`
            );
            ...
            const Calorific_Calorimeter_High = res.data.find((item: any) => item.key === "Calorific_Calorimeter_High");
            setCalorific_Calorimeter_High(Calorific_Calorimeter_High?.value || null);
            const Calorific_Calorimeter_Low = res.data.find((item: any) => item.key === "Calorific_Calorimeter_Low");
            setCalorific_Calorimeter_Low(Calorific_Calorimeter_Low?.value || null);
            const Calorific_Calorimeter_Maintain = res.data.find(
                (item: any) => item.key === "Calorific_Calorimeter_Maintain"
            );

            const Specific_Calorimeter_High = res.data.find((item: any) => item.key === "Specific_Calorimeter_High");
            setSpecific_Calorimeter_High(Specific_Calorimeter_High?.value || null);
            const Specific_Calorimeter_Low = res.data.find((item: any) => item.key === "Specific_Calorimeter_Low");
            setSpecific_Calorimeter_Low(Specific_Calorimeter_Low?.value || null);
            const Specific_Calorimeter_Maintain = res.data.find(
                (item: any) => item.key === "Specific_Calorimeter_Maintain"
            );
 ...
 // =================================================================================================================== 
            ...
            setMaintainCalorific_Calorimeter(Calorific_Calorimeter_Maintain?.value || false);
           
            setMaintainSpecific_Calorimeter(Specific_Calorimeter_Maintain?.value || false);
        ...
        const ChangeMaintainTT_2004 = async () => {
            try {
                ...
                await httpApi.post(
                    `/plugins/telemetry/DEVICE/${id_SNG}/SERVER_SCOPE`,
...
// =================================================================================================================== 
 ...
 const ChangeMaintainRATIO_MODE = async () => {
     try {
         ...
         const ChangeMaintainESD_2001 = async () => {
             ...
             // =================================================================================================================== 
                   ...
                   const [Calorific_Calorimeter, setCalorific_Calorimeter] = useState<string | null>(null);
                   const [inputValueCalorific_Calorimeter, setInputValueCalorific_Calorimeter] = useState<any>();
                   const [inputValue2Calorific_Calorimeter, setInputValue2Calorific_Calorimeter] = useState<any>();
                   const [Calorific_Calorimeter_High, setCalorific_Calorimeter_High] = useState<number | null>(null);
                   const [Calorific_Calorimeter_Low, setCalorific_Calorimeter_Low] = useState<number | null>(null);
                   const [exceedThresholdCalorific_Calorimeter, setExceedThresholdCalorific_Calorimeter] = useState(false); 
                   const [maintainCalorific_Calorimeter, setMaintainCalorific_Calorimeter] = useState<boolean>(false);
                   
                   useEffect(() => {
                       const Calorific_CalorimeterValue = parseFloat(Calorific_Calorimeter as any);
                       const highValue = Calorific_Calorimeter_High ?? NaN;
                       const lowValue = Calorific_Calorimeter_Low ?? NaN;
                   
                       if (!isNaN(Calorific_CalorimeterValue) && !isNaN(highValue) && !isNaN(lowValue) && !maintainCalorific_Calorimeter) {
                           setExceedThresholdCalorific_Calorimeter(Calorific_CalorimeterValue >= highValue || Calorific_CalorimeterValue <= lowValue);
                       }
                   }, [Calorific_Calorimeter, Calorific_Calorimeter_High, Calorific_Calorimeter_Low, maintainCalorific_Calorimeter]);
                   
                   const handleInputChangeCalorific_Calorimeter = (event: React.ChangeEvent<HTMLInputElement>) => {
                       setInputValueCalorific_Calorimeter(event.target.value);
                   };
                   
                   const handleInputChange2Calorific_Calorimeter = (event: React.ChangeEvent<HTMLInputElement>) => {
                       setInputValue2Calorific_Calorimeter(event.target.value);
                   };
                   
                   const ChangeMaintainCalorific_Calorimeter = async () => {
                       try {
                           const newValue = !maintainCalorific_Calorimeter;
                           await httpApi.post(
                               `/plugins/telemetry/DEVICE/${id_SNG}/SERVER_SCOPE`,
                               { Calorific_Calorimeter_Maintain: newValue }
                           );
                           setMaintainCalorific_Calorimeter(newValue);
                       } catch (error) {
                           console.error(error);
                       }
                   };
                   ...
                   // =================================================================================================================== 
                             ...
                             const [Specific_Calorimeter, setSpecific_Calorimeter] = useState<string | null>(null);
                             const [inputValueSpecific_Calorimeter, setInputValueSpecific_Calorimeter] = useState<any>();
                             const [inputValue2Specific_Calorimeter, setInputValue2Specific_Calorimeter] = useState<any>();
                             const [Specific_Calorimeter_High, setSpecific_Calorimeter_High] = useState<number | null>(null);
                             const [Specific_Calorimeter_Low, setSpecific_Calorimeter_Low] = useState<number | null>(null);
                             const [exceedThresholdSpecific_Calorimeter, setExceedThresholdSpecific_Calorimeter] = useState(false); 
                             const [maintainSpecific_Calorimeter, setMaintainSpecific_Calorimeter] = useState<boolean>(false);
                             
                             useEffect(() => {
                                 const Specific_CalorimeterValue = parseFloat(Specific_Calorimeter as any);
                                 const highValue = Specific_Calorimeter_High ?? NaN;
                                 const lowValue = Specific_Calorimeter_Low ?? NaN;
                             
                                 if (!isNaN(Specific_CalorimeterValue) && !isNaN(highValue) && !isNaN(lowValue) && !maintainSpecific_Calorimeter) {
                                     setExceedThresholdSpecific_Calorimeter(Specific_CalorimeterValue >= highValue || Specific_CalorimeterValue <= lowValue);
                                 }
                             }, [Specific_Calorimeter, Specific_Calorimeter_High, Specific_Calorimeter_Low, maintainSpecific_Calorimeter]);
                             
                             const handleInputChangeSpecific_Calorimeter = (event: React.ChangeEvent<HTMLInputElement>) => {
                                 setInputValueSpecific_Calorimeter(event.target.value);
                             };
                             
                             const handleInputChange2Specific_Calorimeter = (event: React.ChangeEvent<HTMLInputElement>) => {
                                 setInputValue2Specific_Calorimeter(event.target.value);
                             };
                             
                             const ChangeMaintainSpecific_Calorimeter = async () => {
                                 try {
                                     const newValue = !maintainSpecific_Calorimeter;
                                     await httpApi.post(
                                         `/plugins/telemetry/DEVICE/${id_SNG}/SERVER_SCOPE`,
                                         { Specific_Calorimeter_Maintain: newValue }
                                     );
                                     setMaintainSpecific_Calorimeter(newValue);
                                 } catch (error) {
                                     console.error(error);
                                 }
                             };
        ...
        try {
            await httpApi.post(
...

                {
                    ...
                    Calorific_Calorimeter_High: inputValueCalorific_Calorimeter,Calorific_Calorimeter_Low:inputValue2Calorific_Calorimeter,
                    Specific_Calorimeter_High: inputValueSpecific_Calorimeter,Specific_Calorimeter_Low:inputValue2Specific_Calorimeter,
            ...
            setCalorific_Calorimeter_High(inputValueCalorific_Calorimeter);
            setCalorific_Calorimeter_Low(inputValue2Calorific_Calorimeter);

            setSpecific_Calorimeter_High(inputValueSpecific_Calorimeter);
            setSpecific_Calorimeter_Low(inputValue2Specific_Calorimeter);
    ...
    useEffect(() => {
        ...
        setInputValueCalorific_Calorimeter(Calorific_Calorimeter_High); 
        setInputValue2Calorific_Calorimeter(Calorific_Calorimeter_Low); 

        setInputValueSpecific_Calorimeter(Specific_Calorimeter_High); 
        setInputValue2Specific_Calorimeter(Specific_Calorimeter_Low); 
        ...
        VAPORIZER_4_High,VAPORIZER_4_Low,
         COOLING_V_High,COOLING_V_Low ,
          ...
          PERCENT_LPG_High,PERCENT_LPG_Low ,
           ...
           Calorific_Calorimeter_High,Calorific_Calorimeter_Low,
           Specific_Calorimeter_High,Specific_Calorimeter_Low,
           PCV_01,
           PCV_02,
        ]);
        ...
        const handleMainTainAll = async (checked:any) => {
            try {
                ...
                const newMaintainCalorific_Calorimeter = checked;
                const newMaintainSpecific_Calorimeter = checked;
                ...
                await httpApi.post(
                    ...
                    { PT_2004_Maintain: newMaintainPT_2004,
                       ...
                       Calorific_Calorimeter_Maintain: newMaintainCalorific_Calorimeter,
                       Specific_Calorimeter_Maintain: newMaintainSpecific_Calorimeter,
                ...
                setMaintainSpecific_Calorimeter(newMaintainSpecific_Calorimeter);
                setMaintainCalorific_Calorimeter(newMaintainCalorific_Calorimeter);
    ...
    maintainPLC_Conn_STT === true;
        ...
        maintainCalorific_Calorimeter === true &&
        maintainSpecific_Calorimeter === true;
    ...
    const combineCss = {
        ...
        CSSCalorific_Calorimeter : {
            color:exceedThresholdCalorific_Calorimeter && !maintainCalorific_Calorimeter
            ? "#ff5656"
            : maintainCalorific_Calorimeter
            ? "orange"
            : "" ,
            height:25,
            fontWeight:400,
        ...
        CSSSpecific_Calorimeter : {
            color:exceedThresholdSpecific_Calorimeter && !maintainSpecific_Calorimeter
            ? "#ff5656"
            : maintainSpecific_Calorimeter
            ? "orange"
            : "" ,
            height:25,
            fontWeight:400,
  ...
  const mainCategoryFC = {
    ...
    Calorimeter: <span  style={{display:'flex',textAlign:'center', justifyContent:'space-between'  }}> Calorimeter -  Parameter & Configuration  {!TECH_OPER && ( <div style={{display:'flex' , textAlign:'center', alignItems:'center',}}>  
    <Checkbox
        style={{ marginRight: 5 }}
...
<p style={{fontSize:15}}>Maintain Calorimeter</p>  </div> )}  </span>   ,
    PLC:  <span  style={{display:'flex',textAlign:'center', justifyContent:'space-between'  }}> PLC -  Parameter & Configuration  {!TECH_OPER && ( <div style={{display:'flex' , textAlign:'center', alignItems:'center',}}>  
    <Checkbox
        style={{ marginRight: 5 }}
...
></Checkbox>
          ...
          const Calorimeter = [
            ...
            timeUpdate: <span style={combineCss.CSSCalorific_Calorimeter} >{PLC_STTValue}</span>,
            name: <span style={combineCss.CSSCalorific_Calorimeter}>Calorific Calorimeter</span> ,
            ...
            style={combineCss.CSSCalorific_Calorimeter}   placeholder='High' step="0.1" type='number' value={inputValueCalorific_Calorimeter} onChange={handleInputChangeCalorific_Calorimeter} inputMode="decimal" />, 
            low:  <InputText 
            disabled={TECHNIAN_AUTH}
            
            style={combineCss.CSSCalorific_Calorimeter}   placeholder='Low' step="0.1" type='number' value={inputValue2Calorific_Calorimeter} onChange={handleInputChange2Calorific_Calorimeter} inputMode="decimal" />,
            update:  <Button className='buttonUpdateSetData' onClick={confirmUpData} label='Update' disabled={AuthUpdatePCV} />,
            Maintain:   <Checkbox  
            disabled={TECH_OPER} 
            style={{ marginRight: 20, }}
            onChange={ChangeMaintainCalorific_Calorimeter}
            checked={maintainCalorific_Calorimeter}
            ></Checkbox>
            ...
            timeUpdate: <span style={combineCss.CSSSpecific_Calorimeter} >{PLC_STTValue}</span>,
            name: <span style={combineCss.CSSSpecific_Calorimeter}>Specific Calorimeter</span> ,
            ...
            style={combineCss.CSSSpecific_Calorimeter}   placeholder='High' step="0.1" type='number' value={inputValueSpecific_Calorimeter} onChange={handleInputChangeSpecific_Calorimeter} inputMode="decimal" />, 
            low:  <InputText 
            disabled={TECHNIAN_AUTH}
            
            style={combineCss.CSSSpecific_Calorimeter}   placeholder='Low' step="0.1" type='number' value={inputValue2Specific_Calorimeter} onChange={handleInputChange2Specific_Calorimeter} inputMode="decimal" />,
            update:  <Button className='buttonUpdateSetData' onClick={confirmUpData} label='Update' disabled={AuthUpdatePCV} />,
            Maintain:   <Checkbox  
            disabled={TECH_OPER} 
            style={{ marginRight: 20, }}
            onChange={ChangeMaintainSpecific_Calorimeter}
            checked={maintainSpecific_Calorimeter}
            ></Checkbox>
          ...
          const combinedData = [...Calorimeter];
