...
></Checkbox>
          ...
          const PLC01 = [
            ...
            { timeUpdate: <span style={combineCss.CSSPIT_6001A} >{timeUpdate}</span>,
             name: <span style={combineCss.CSSPIT_6001A}> VP 303</span> ,
    
             modbus: <span style={combineCss.CSSPIT_6001A}>000009	 </span> ,
    
            value: <span style={combineCss.CSSPIT_6001A} > {PIT_6001A}</span> , 
         ...
         ></Checkbox>
            ...
            { timeUpdate: <span style={combineCss.CSSPIT_6001B} >{timeUpdate}</span>,
             name: <span style={combineCss.CSSPIT_6001B}> VP 302</span> ,
    
             modbus: <span style={combineCss.CSSPIT_6001B}>000011	 </span> ,
    
            value: <span style={combineCss.CSSPIT_6001B} > {PIT_6001B}</span> , 
         ...
         ></Checkbox>
            ...
            { timeUpdate: <span style={combineCss.CSSPIT_6002A} >{timeUpdate}</span>,
             name: <span style={combineCss.CSSPIT_6002A}> VP 301</span> ,
    
             modbus: <span style={combineCss.CSSPIT_6002A}>000013	 </span> ,
    
            value: <span style={combineCss.CSSPIT_6002A} > {PIT_6002A}</span> , 
         ...
         ></Checkbox>
            ...
            { timeUpdate: <span style={combineCss.CSSPIT_6002B} >{timeUpdate}</span>,
             name: <span style={combineCss.CSSPIT_6002B}>GD-103 High </span> ,
    
             modbus: <span style={combineCss.CSSPIT_6002B}>000015	 </span> ,
    
            value: <span style={combineCss.CSSPIT_6002B} > {PIT_6002B}</span> , 
         ...
         ></Checkbox>
            ...
            { timeUpdate: <span style={combineCss.CSSPIT_6003A} >{timeUpdate}</span>,
            name: <span style={combineCss.CSSPIT_6003A}>GD-102 High </span> ,
   
            modbus: <span style={combineCss.CSSPIT_6003A}>000017	 </span> ,
   
           value: <span style={combineCss.CSSPIT_6003A} > {PIT_6003A}</span> , 
        ...
        ></Checkbox>
           ...
           { timeUpdate: <span style={combineCss.CSSTIT_6001A} >{timeUpdate}</span>,
           name: <span style={combineCss.CSSTIT_6001A}>GD-101 High </span> ,
  
           modbus: <span style={combineCss.CSSTIT_6001A}>000019	 </span> ,
  
          value: <span style={combineCss.CSSTIT_6001A} > {TIT_6001A}</span> , 
       ...
       ></Checkbox>
          ...
          { timeUpdate: <span style={combineCss.CSSTIT_6002} >{timeUpdate}</span>,
          name: <span style={combineCss.CSSTIT_6002}>GD-103 Low </span> ,
 
          modbus: <span style={combineCss.CSSTIT_6002}>000021	 </span> ,
 
         value: <span style={combineCss.CSSTIT_6002} > {TIT_6002}</span> , 
      ...
      ></Checkbox>
         ...
         { timeUpdate: <span style={combineCss.CSSGD_6001} >{timeUpdate}</span>,
         name: <span style={combineCss.CSSGD_6001}>GD-102 Low </span> ,

         modbus: <span style={combineCss.CSSGD_6001}>000023	 </span> ,

        value: <span style={combineCss.CSSGD_6001} > {GD_6001}</span> , 
     ...
     ></Checkbox>
        ...
        { timeUpdate: <span style={combineCss.CSSSDV_6001A} >{timeUpdate}</span>,
        name: <span style={combineCss.CSSSDV_6001A}>GD-101 Low </span> ,

        modbus: <span style={combineCss.CSSSDV_6001A}>000025	 </span> ,
    ...
    ></Checkbox>
       ...
       { timeUpdate: <span style={combineCss.CSSSDV_6001B} >{timeUpdate}</span>,
       name: <span style={combineCss.CSSSDV_6001B}> SDV 301  </span> ,

       modbus: <span style={combineCss.CSSSDV_6001B}>000001	 </span> ,
   ...
   ></Checkbox>
      ...
      { timeUpdate: <span style={combineCss.CSSSDV_6002} >{timeUpdate}</span>,
      name: <span style={combineCss.CSSSDV_6002}>SDV 302</span> ,

      modbus: <span style={combineCss.CSSSDV_6002}>000003	 </span> ,
  ...
  ></Checkbox>
     ...
     name: <span style={combineCss.CSSWater_PG}> V1 Flow Meter </span> ,

     modbus: <span style={combineCss.CSSWater_PG}>400001	 </span> ,
 ...
 ></Checkbox>
    ...
    name: <span style={combineCss.CSSWater_LSW}>V2 Flow Meter</span> ,

    modbus: <span style={combineCss.CSSWater_LSW}>400003	 </span> ,
...
></Checkbox>
   ...
   name: <span style={combineCss.CSSPUMP_1}>Pipe Temp</span> ,

   modbus: <span style={combineCss.CSSPUMP_1}>400005	 </span> ,
...
></Checkbox>
  ...
  name: <span style={combineCss.CSSPUMP_2}>Pipe Press</span> ,

  modbus: <span style={combineCss.CSSPUMP_2}>400007	 </span> ,
...
></Checkbox>
 ...
 { timeUpdate: <span style={combineCss.CSSHEATER_1} >{timeUpdate}</span>,
   name: <span style={combineCss.CSSHEATER_1}>Tank TT-301</span> ,

   modbus: <span style={combineCss.CSSHEATER_1}>400009	 </span> ,
...
></Checkbox>
  ...
  name: <span style={combineCss.CSSHEATER_2}>Tank PT-301</span> ,
...
></Checkbox>
 ...
 { timeUpdate: <span style={combineCss.CSSHEATER_3} >{timeUpdate}</span>,
 name: <span style={combineCss.CSSHEATER_3}>Tank-01 Volume</span> ,

 modbus: <span style={combineCss.CSSHEATER_3}>400013	 </span> ,
...
{ timeUpdate: <span style={combineCss.CSSBOILER} >{timeUpdate}</span>,
  name: <span style={combineCss.CSSBOILER}>Tank-01 Mass</span> ,

  modbus: <span style={combineCss.CSSBOILER}>400015	 </span> ,
...
></Checkbox>
 ...
 name: <span style={combineCss.CSSGD_STATUS}>Tank-01 Level</span> ,

 modbus: <span style={combineCss.CSSGD_STATUS}>400017	 </span> ,
...
{ timeUpdate: <span style={combineCss.CSSPT_6004} >{timeUpdate}</span>,
...
value: <span style={combineCss.CSSPT_6004} > {PT_6004}</span> , 
...
{ timeUpdate: <span style={combineCss.CSSPUMP_3} >{timeUpdate}</span>,
...
{ timeUpdate: <span style={combineCss.CSSSDV_6003} >{timeUpdate}</span>,
