...
const ChangeMaintainPLC_Conn_STT = async () => {
  ...
  const mainCategoryFC = {
    FC01: <span  style={{display:'flex',textAlign:'center', justifyContent:'space-between'  }}> FC-1801 -  Parameters & Configurations  <div style={{display:'flex' , textAlign:'center', alignItems:'center',}}>  
        <Checkbox
        disabled={TECH_OPER}
            style={{ marginRight: 5 }}
        ...
        />
    <p style={{fontSize:15}}>Maintain FC-1801</p>  </div>  </span> ,
    FC02: 'FC-1802 -  Parameters & Configurations',
...
></Checkbox>
            ...
            value: <span style={combineCss.CSSFC_02_Yesterday_Values_Volume} > {formatValue(FC_02_Yesterday_Values_Volume)}  {nameValue.Sm3}</span> , 
             ...
             low:  <InputText disabled={TECHNIAN_AUTH} style={combineCss.CSSFC_02_Yesterday_Values_Volume}   placeholder='Low' step="0.1" type='number' value={inputValue2FC_02_Yesterday_Values_Volume} onChange={handleInputChange2VP303} inputMode="decimal" />,
             update:  <Button className='buttonUpdateSetData' onClick={confirmUpData} label='Update' disabled={TECHNIAN_AUTH} />,
             Maintain:   <Checkbox
             disabled={TECH_OPER}
             style={{ marginRight: 20, }}
        ...
        const PLC = [

            {
             ...
             name: <span style={combineCss.CSSGD1}>Gas Detector GD-1801</span> ,
         ...
         ></Checkbox>
...

            {
             ...
             name: <span style={combineCss.CSSGD2}>Gas Detector GD-1802</span> ,
        ...
        ></Checkbox>
           ...
           name: <span style={combineCss.CSSDI_ZSO_1}>SDV-1801 ZSO</span> ,
       ...
       ></Checkbox>
         ...
         name: <span style={combineCss.CSSDI_ZSC_1}>SDV-1801 ZSC</span> ,
...
></Checkbox>
 ...
 name: <span style={combineCss.CSSDI_SD_1}>Smoker Detected SD-1801</span> ,
...
value: <span style={combineCss.CSSDO_BC_01} > {formatValue(DO_BC_01)} {DataDO_HR_01}</span> , 
...
value: <span style={combineCss.CSSDO_HR_01} > {formatValue(DO_HR_01)} {DataDO_BC_01}</span> , 
...
name: <span style={combineCss.CSSDO_SV_01}>SDV-1801 SOLENOID</span> ,
...
high: <InputText disabled={TECHNIAN_AUTH} style={combineCss.CSSDO_SV_01}   placeholder='High' step="0.1" type='number' value={inputValuDO_SV_01} onChange={handleInputChangeDO_SV_01} inputMode="decimal" />, 
...
></Checkbox>
    ...
    const Configuration = [
        {
            Name: <span style={combineCssAttribute.PCV}>{namePCV_PSV.control} (PCV-1801) (BarG)</span>,
        ...
        {
            Name: <span style={combineCssAttribute.PCV}>{namePCV_PSV.control} (PCV-1802) (BarG)</span>,
        ...
        {
            Name: <span style={combineCssAttribute.PCV}>{namePCV_PSV.safety} (PSV-1801) (BarG)</span>,
