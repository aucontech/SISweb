...
// =================================================================================================================== 
 ...
 useEffect(() => {
  ...
  const mainCategoryFC = {
    FC: 'FC -  Prameters & configurations',
    FC01: 'FC-1801 -  Prameters & configurations',
    FC02: 'FC-1802 -  Prameters & configurations',
    PLC: 'PLC -  Prameters & configurations'
};
...
high: <InputText  disabled={AuthInputHighLow} style={combineCss.CSSDO_SV_01}   placeholder='High' step="0.1" type='number' value={inputValuDO_SV_01} onChange={handleInputChangDO_SV_01} inputMode="decimal" />, 
        ...
        },
        {
            ...
            Update: 
                ...
                disabled={AuthInputHighLow}
                  ...
                  onClick={confirmUpData} label="Update" /> ,
