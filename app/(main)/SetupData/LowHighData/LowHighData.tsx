...
export default function LowHighData() {
    ...
    const [HighTemperature01, setHighTemperature01] = useState<number | null>(
        null
    );
    const [LowTemperature01, setLowTemperature01] = useState<number | null>(
        null
    );
    const [AlarmTemperature01, setAlarmTemperature01] = useState(false); // State để lưu trữ trạng thái vượt ngưỡng
    const [maintainTemperature01, setMaintainTemperature01] =
        useState<boolean>(false);

    useEffect(() => {
        if (
            typeof HighTemperature01 === "string" &&
            typeof LowTemperature01 === "string" &&
            Temperature01 !== null &&
            maintainTemperature01 === false
        ) {
            ...
            if (
                !isNaN(highValue) &&
                !isNaN(lowValue) &&
                !isNaN(Temperature01Value)
            ) {
                if (
                    highValue < Temperature01Value ||
                    Temperature01Value < lowValue
                ) {
    ...
    const [HighTemperature02, setHighTemperature02] = useState<number | null>(
        null
    );
    const [LowTemperature02, setLowTemperature02] = useState<number | null>(
        null
    );
    const [AlarmTemperature02, setAlarmTemperature02] = useState(false); // State để lưu trữ trạng thái vượt ngưỡng
    const [maintainTemperature02, setMaintainTemperature02] =
        useState<boolean>(false);

    useEffect(() => {
        if (
            typeof HighTemperature02 === "string" &&
            typeof LowTemperature02 === "string" &&
            Temperature02 !== null &&
            maintainTemperature02 === false
        ) {
            ...
            if (
                !isNaN(highValue) &&
                !isNaN(lowValue) &&
                !isNaN(Temperature02Value)
            ) {
                if (
                    highValue < Temperature02Value ||
                    Temperature02Value < lowValue
                ) {
    ...
    const [maintainReBattery01, setMaintainReBattery01] =
        useState<boolean>(false);

    useEffect(() => {
        if (
            typeof HighReBattery01 === "string" &&
            typeof LowReBattery01 === "string" &&
            ReBattery01 !== null &&
            maintainReBattery01 === false
        ) {
            ...
            if (
                !isNaN(highValue) &&
                !isNaN(lowValue) &&
                !isNaN(ReBattery01Value)
            ) {
                if (
                    highValue < ReBattery01Value ||
                    ReBattery01Value < lowValue
                ) {
                    if (!AudioReBattery01) {
                        audioRef.current?.play();
    ...
    const [maintainReBattery02, setMaintainReBattery02] =
        useState<boolean>(false);

    useEffect(() => {
        if (
            typeof HighReBattery02 === "string" &&
            typeof LowReBattery02 === "string" &&
            ReBattery02 !== null &&
            maintainReBattery02 === false
        ) {
            ...
            if (
                !isNaN(highValue) &&
                !isNaN(lowValue) &&
                !isNaN(ReBattery02Value)
            ) {
                if (
                    highValue < ReBattery02Value ||
                    ReBattery02Value < lowValue
                ) {
                    if (!AudioReBattery02) {
                        audioRef.current?.play();
    ...
    const [maintainVmLastDay01, setMaintainVmLastDay01] =
        useState<boolean>(false);

    useEffect(() => {
        if (
            typeof HighVmLastDay01 === "string" &&
            typeof LowVmLastDay01 === "string" &&
            VmLastDay01 !== null &&
            maintainVmLastDay01 === false
        ) {
            ...
            if (
                !isNaN(highValue) &&
                !isNaN(lowValue) &&
                !isNaN(VmLastDay01Value)
            ) {
                if (
                    highValue < VmLastDay01Value ||
                    VmLastDay01Value < lowValue
                ) {
                    if (!AudioVmLastDay01) {
                        audioRef.current?.play();
    ...
    const [maintainVmLastDay02, setMaintainVmLastDay02] =
        useState<boolean>(false);

    useEffect(() => {
        if (
            typeof HighVmLastDay02 === "string" &&
            typeof LowVmLastDay02 === "string" &&
            VmLastDay02 !== null &&
            maintainVmLastDay02 === false
        ) {
            ...
            if (
                !isNaN(highValue) &&
                !isNaN(lowValue) &&
                !isNaN(VmLastDay02Value)
            ) {
                if (
                    highValue < VmLastDay02Value ||
                    VmLastDay02Value < lowValue
                ) {
                    if (!AudioVmLastDay02) {
                        audioRef.current?.play();
    ...
    const [maintainVbLastDay01, setMaintainVbLastDay01] =
        useState<boolean>(false);

    useEffect(() => {
        if (
            typeof HighVbLastDay01 === "string" &&
            typeof LowVbLastDay01 === "string" &&
            VbLastDay01 !== null &&
            maintainVbLastDay01 === false
        ) {
            ...
            if (
                !isNaN(highValue) &&
                !isNaN(lowValue) &&
                !isNaN(VbLastDay01Value)
            ) {
                if (
                    highValue < VbLastDay01Value ||
                    VbLastDay01Value < lowValue
                ) {
                    if (!AudioVbLastDay01) {
                        audioRef.current?.play();
    ...
    const [maintainVbLastDay02, setMaintainVbLastDay02] =
        useState<boolean>(false);

    useEffect(() => {
        if (
            typeof HighVbLastDay02 === "string" &&
            typeof LowVbLastDay02 === "string" &&
            VbLastDay02 !== null &&
            maintainVbLastDay02 === false
        ) {
            ...
            if (
                !isNaN(highValue) &&
                !isNaN(lowValue) &&
                !isNaN(VbLastDay02Value)
            ) {
                if (
                    highValue < VbLastDay02Value ||
                    VbLastDay02Value < lowValue
                ) {
                    if (!AudioVbLastDay02) {
                        audioRef.current?.play();
    ...
    useEffect(() => {
        if (
            typeof HighVmToDay01 === "string" &&
            typeof LowVmToDay01 === "string" &&
            VmToDay01 !== null &&
            maintainVmToDay01 === false
        ) {
    ...
    useEffect(() => {
        if (
            typeof HighVmToDay02 === "string" &&
            typeof LowVmToDay02 === "string" &&
            VmToDay02 !== null &&
            maintainVmToDay02 === false
        ) {
    ...
    useEffect(() => {
        if (
            typeof HighVbToDay01 === "string" &&
            typeof LowVbToDay01 === "string" &&
            VbToDay01 !== null &&
            maintainVbToDay01 === false
        ) {
    ...
    useEffect(() => {
        if (
            typeof HighVbToDay02 === "string" &&
            typeof LowVbToDay02 === "string" &&
            VbToDay02 !== null &&
            maintainVbToDay02 === false
        ) {
    ...
    const [maintainUpsBattery, setMaintainUpsBattery] =
        useState<boolean>(false);

    useEffect(() => {
        if (
            typeof HighUpsBattery === "string" &&
            typeof LowUpsBattery === "string" &&
            UpsBattery !== null &&
            maintainUpsBattery === false
        ) {
    ...
    const [maintainUpsCharging, setMaintainUpsCharging] =
        useState<boolean>(false);

    useEffect(() => {
        if (
            typeof HighUpsCharging === "string" &&
            typeof LowUpsCharging === "string" &&
            UpsCharging !== null &&
            maintainUpsCharging === false
        ) {
            ...
            if (
                !isNaN(highValue) &&
                !isNaN(lowValue) &&
                !isNaN(UpsChargingValue)
            ) {
                if (
                    highValue < UpsChargingValue ||
                    UpsChargingValue < lowValue
                ) {
                    if (!AudioUpsCharging) {
                        audioRef.current?.play();
    ...
    useEffect(() => {
        if (
            typeof HighUpsAlarm === "string" &&
            typeof LowUpsAlarm === "string" &&
            UpsAlarm !== null &&
            maintainUpsAlarm === false
        ) {
    ...
    useEffect(() => {
        if (
            typeof HighUpsMode === "string" &&
            typeof LowUpsMode === "string" &&
            UpsMode !== null &&
            maintainUpsMode === false
        ) {
    ...
    useEffect(() => {
        if (
            typeof HighSelectSW === "string" &&
            typeof LowSelectSW === "string" &&
            SelectSW !== null &&
            maintainSelectSW === false
        ) {
    ...
    const [maintainEmergencyNC, setMaintainEmergencyNC] =
        useState<boolean>(false);

    useEffect(() => {
        if (
            typeof HighEmergencyNC === "string" &&
            typeof LowEmergencyNC === "string" &&
            EmergencyNC !== null &&
            maintainEmergencyNC === false
        ) {
            ...
            if (
                !isNaN(highValue) &&
                !isNaN(lowValue) &&
                !isNaN(EmergencyNCValue)
            ) {
                if (
                    highValue < EmergencyNCValue ||
                    EmergencyNCValue < lowValue
                ) {
                    if (!AudioEmergencyNC) {
                        audioRef.current?.play();
    ...
    const [maintainEmergencyNO, setMaintainEmergencyNO] =
        useState<boolean>(false);

    useEffect(() => {
        if (
            typeof HighEmergencyNO === "string" &&
            typeof LowEmergencyNO === "string" &&
            EmergencyNO !== null &&
            maintainEmergencyNO === false
        ) {
            ...
            if (
                !isNaN(highValue) &&
                !isNaN(lowValue) &&
                !isNaN(EmergencyNOValue)
            ) {
                if (
                    highValue < EmergencyNOValue ||
                    EmergencyNOValue < lowValue
                ) {
                    if (!AudioEmergencyNO) {
                        audioRef.current?.play();
    ...
    useEffect(() => {
        if (
            typeof HighDIReset === "string" &&
            typeof LowDIReset === "string" &&
            DIReset !== null &&
            maintainDIReset === false
        ) {
    ...
    useEffect(() => {
        if (
            typeof HighDOHorn === "string" &&
            typeof LowDOHorn === "string" &&
            DOHorn !== null &&
            maintainDOHorn === false
        ) {
    ...
    useEffect(() => {
        if (
            typeof HighMap === "string" &&
            typeof LowMap === "string" &&
            Map !== null &&
            maintainMap === false
        ) {
    ...
    useEffect(() => {
        if (
            typeof HighDO_SV1 === "string" &&
            typeof LowDO_SV1 === "string" &&
            DO_SV1 !== null &&
            maintainDO_SV1 === false
        ) {
    ...
    useEffect(() => {
        if (
            typeof HighZSC_1 === "string" &&
            typeof LowZSC_1 === "string" &&
            ZSC_1 !== null &&
            maintainZSC_1 === false
        ) {
    ...
    useEffect(() => {
        if (
            typeof HighZSO_1 === "string" &&
            typeof LowZSO_1 === "string" &&
            ZSO_1 !== null &&
            maintainZSO_1 === false
        ) {
    ...
    useEffect(() => {
        if (
            typeof HighBeacon === "string" &&
            typeof LowBeacon === "string" &&
            Beacon !== null &&
            maintainBeacon === false
        ) {
    ...
    const handleButtonClick = async () => {
        try {
            await httpApi.post(
                `/plugins/telemetry/DEVICE/${id_OTSUKA}/SERVER_SCOPE`,
                {
                    EVC_01_Pressure_High: inputValue,
                    EVC_01_Pressure_Low: inputValue2,
                    EVC_02_Pressure_High: inputValueEK2Hight,
                    EVC_02_Pressure_Low: inputValueEK1Low,
                    PT1_High: inputValueEK3Hight,
                    PT1_Low: inputValueEK3Low,

                    GD1_High: inputHighGD01,
                    GD1_Low: inputLowGD01,
                    GD2_High: inputHighGD02,
                    GD2_Low: inputLowGD02,
                    GD3_High: inputHighGD03,
                    GD3_Low: inputLowGD03,

                    EVC_01_Flow_at_Measurement_Condition_High: inputHighGVF1,
                    EVC_01_Flow_at_Measurement_Condition_Low: inputLowGVF1,
                    EVC_01_Flow_at_Base_Condition_High: inputHighSVF1,
                    EVC_01_Flow_at_Base_Condition_Low: inputLowSVF1,
                    EVC_01_Volume_at_Base_Condition_High: inputHighSVA1,
                    EVC_01_Volume_at_Base_Condition_Low: inputLowSVA1,
                    EVC_01_Volume_at_Measurement_Condition_High: inputHighGVA1,
                    EVC_01_Volume_at_Measurement_Condition_Low: inputLowGVA1,

                    EVC_02_Flow_at_Measurement_Condition_High: inputHighGVF2,
                    EVC_02_Flow_at_Measurement_Condition_Low: inputLowGVF2,
                    EVC_02_Flow_at_Base_Condition_High: inputHighSVF2,
                    EVC_02_Flow_at_Base_Condition_Low: inputLowSVF2,
                    EVC_02_Volume_at_Base_Condition_High: inputHighSVA2,
                    EVC_02_Volume_at_Base_Condition_Low: inputLowSVA2,
                    EVC_02_Volume_at_Measurement_Condition_High: inputHighGVA2,
                    EVC_02_Volume_at_Measurement_Condition_Low: inputLowGVA2,

                    EVC_01_Temperature_High: inputHighTemperature01,
                    EVC_01_Temperature_Low: inputLowTemperature01,
                    EVC_02_Temperature_High: inputHighTemperature02,
                    EVC_02_Temperature_Low: inputLowTemperature02,

                    EVC_01_Remain_Battery_Service_Life_High:
                        inputHighReBattery01,
                    EVC_01_Remain_Battery_Service_Life_Low: inputLowReBattery01,
                    EVC_02_Remain_Battery_Service_Life_High:
                        inputHighReBattery02,
                    EVC_02_Remain_Battery_Service_Life_Low: inputLowReBattery02,

                    EVC_01_Vm_of_Last_Day_High: inputHighVmLastDay01,
                    EVC_01_Vm_of_Last_Day_Low: inputLowVmLastDay01,
                    EVC_02_Vm_of_Last_Day_High: inputHighVmLastDay02,
                    EVC_02_Vm_of_Last_Day_Low: inputLowVmLastDay02,

                    EVC_01_Vb_of_Last_Day_High: inputHighVbLastDay01,
                    EVC_01_Vb_of_Last_Day_Low: inputLowVbLastDay01,
                    EVC_02_Vb_of_Last_Day_High: inputHighVbLastDay02,
                    EVC_02_Vb_of_Last_Day_Low: inputLowVbLastDay02,

                    EVC_01_Vb_of_Current_Day_High: inputHighVbToDay01,
                    EVC_01_Vb_of_Current_Day_Low: inputLowVbToDay01,
                    EVC_02_Vb_of_Current_Day_High: inputHighVbToDay02,
                    EVC_02_Vb_of_Current_Day_Low: inputLowVbToDay02,

                    EVC_01_Vm_of_Current_Day_High: inputHighVmToDay01,
                    EVC_01_Vm_of_Current_Day_Low: inputLowVmToDay01,
                    EVC_02_Vm_of_Current_Day_High: inputHighVmToDay02,
                    EVC_02_Vm_of_Current_Day_Low: inputLowVmToDay02,

                    DI_UPS_BATTERY_High: inputHighUpsBattery,
                    DI_UPS_BATTERY_Low: inputLowUpsBattery,
                    DI_UPS_CHARGING_High: inputHighUpsCharging,
                    DI_UPS_CHARGING_Low: inputLowUpsCharging,

                    DI_UPS_ALARM_High: inputHighUpsAlarm,
                    DI_UPS_ALARM_Low: inputLowUpsAlarm,
                    UPS_Mode_High: inputHighUpsMode,
                    UPS_Mode_Low: inputLowUpsMode,

                    DI_SELECT_SW_High: inputHighSelectSW,
                    DI_SELECT_SW_Low: inputLowSelectSW,

                    Emergency_NO_High: inputHighEmergencyNO,
                    Emergency_NO_Low: inputLowEmergencyNO,
                    Emergency_NC_High: inputHighEmergencyNC,
                    Emergency_NC_Low: inputLowEmergencyNC,

                    DI_RESET_High: inputHighDIReset,
                    DI_RESET_Low: inputLowDIReset,

                    DO_HR_01_High: inputHighDOHorn,
                    DO_HR_01_Low: inputLowDOHorn,

                    DI_MAP_1_High: inputHighMap,
                    DI_MAP_1_Low: inputLowMap,

                    DI_ZSC_1_High: inputHighZSC_1,
                    DI_ZSC_1_Low: inputLowZSC_1,
                    DI_ZSO_1_High: inputHighZSO_1,
                    DI_ZSO_1_Low: inputLowZSO_1,

                    DO_SV_01_High: inputHighDO_SV1,
                    DO_SV_01_Low: inputLowDO_SV1,
                    DO_BC_01_High: inputHighBeacon,
                    DO_BC_01_Low: inputLowBeacon,
                }
            );
    ...
    const combineCss = {
        ...
        CSS_Temperature: {
            color:
                AlarmTemperature01 && !maintainTemperature01
                    ? "#ff5656"
                    : maintainTemperature01
                    ? "orange"
                    : "",
        ...
        CSS_Temperature02: {
            color:
                AlarmTemperature02 && !maintainTemperature02
                    ? "#ff5656"
                    : maintainTemperature02
                    ? "orange"
                    : "",
        ...
        CSS_Rebattery: {
            color:
                AlarmReBattery01 && !maintainReBattery01
                    ? "#ff5656"
                    : maintainReBattery01
                    ? "orange"
                    : "",
        ...
        CSS_Rebattery02: {
            color:
                AlarmReBattery02 && !maintainReBattery02
                    ? "#ff5656"
                    : maintainReBattery02
                    ? "orange"
                    : "",
        ...
        CSS_VmLastDay01: {
            color:
                AlarmVmLastDay01 && !maintainVmLastDay01
                    ? "#ff5656"
                    : maintainVmLastDay01
                    ? "orange"
                    : "",
        ...
        CSS_VmLastDay02: {
            color:
                AlarmVmLastDay02 && !maintainVmLastDay02
                    ? "#ff5656"
                    : maintainVmLastDay02
                    ? "orange"
                    : "",
        ...
        CSS_VbLastDay01: {
            color:
                AlarmVbLastDay01 && !maintainVbLastDay01
                    ? "#ff5656"
                    : maintainVbLastDay01
                    ? "orange"
                    : "",
        ...
        CSS_VbLastDay02: {
            color:
                AlarmVbLastDay02 && !maintainVbLastDay02
                    ? "#ff5656"
                    : maintainVbLastDay02
                    ? "orange"
                    : "",
        ...
        CSS_VmToDay01: {
            color:
                AlarmVmToDay01 && !maintainVmToDay01
                    ? "#ff5656"
                    : maintainVmToDay01
                    ? "orange"
                    : "",
        ...
        CSS_VmToDay02: {
            color:
                AlarmVmToDay02 && !maintainVmToDay02
                    ? "#ff5656"
                    : maintainVmToDay02
                    ? "orange"
                    : "",
        ...
        CSS_VbToDay01: {
            color:
                AlarmVbToDay01 && !maintainVbToDay01
                    ? "#ff5656"
                    : maintainVbToDay01
                    ? "orange"
                    : "",
        ...
        CSS_VbToDay02: {
            color:
                AlarmVbToDay02 && !maintainVbToDay02
                    ? "#ff5656"
                    : maintainVbToDay02
                    ? "orange"
                    : "",
        ...
        CSS_UpsBattery: {
            color:
                AlarmUpsBattery && !maintainUpsBattery
                    ? "#ff5656"
                    : maintainUpsBattery
                    ? "orange"
                    : "",
        ...
        CSS_UpsCharging: {
            color:
                AlarmUpsCharging && !maintainUpsCharging
                    ? "#ff5656"
                    : maintainUpsCharging
                    ? "orange"
                    : "",
        ...
        CSS_UpsAlarm: {
            color:
                AlarmUpsAlarm && !maintainUpsAlarm
                    ? "#ff5656"
                    : maintainUpsAlarm
                    ? "orange"
                    : "",
        ...
        CSS_SelectSW: {
            color:
                AlarmSelectSW && !maintainSelectSW
                    ? "#ff5656"
                    : maintainSelectSW
                    ? "orange"
                    : "",
        ...
        CSS_EmergencyNO: {
            color:
                AlarmEmergencyNO && !maintainEmergencyNO
                    ? "#ff5656"
                    : maintainEmergencyNO
                    ? "orange"
                    : "",
        ...
        CSS_EmergencyNC: {
            color:
                AlarmEmergencyNC && !maintainEmergencyNC
                    ? "#ff5656"
                    : maintainEmergencyNC
                    ? "orange"
                    : "",
    ...
    const dataEVC01 = [
        {
            ...
            update: (
                <button className="buttonUpdateSetData" onClick={confirmUpData}>
                    {" "}
                    Update{" "}
                </button>
            ),
        ...
        {
            timeUpdate: (
                <span style={combineCss.CSS_VbToDay01}>{timeUpdate}</span>
            ),
            name: <span style={combineCss.CSS_VbToDay01}> VB Today</span>,

            value: (
                <span style={combineCss.CSS_VbToDay01}> {VbToDay01} Sm³</span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_VbToDay01}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighVbToDay01}
                    onChange={handleInputChangeHighVbToDay01}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowVbToDay01}
                    onChange={handleInputChangeLowVbToDay01}
                    inputMode="decimal"
                />
            ),
            update: (
        ...
        {
            timeUpdate: (
                <span style={combineCss.CSS_VmToDay01}>{timeUpdate}</span>
            ),
            name: <span style={combineCss.CSS_VmToDay01}> VM Today</span>,

            value: (
                <span style={combineCss.CSS_VmToDay01}> {VmToDay01} m³</span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_VmToDay01}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighVmToDay01}
                    onChange={handleInputChangeHighVmToDay01}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowVmToDay01}
                    onChange={handleInputChangeLowVmToDay01}
                    inputMode="decimal"
                />
            ),
            update: (
        ...
        {
            timeUpdate: (
                <span style={combineCss.CSS_VbLastDay01}>{timeUpdate}</span>
            ),
            name: <span style={combineCss.CSS_VbLastDay01}> VB Yesterday</span>,

            value: (
                <span style={combineCss.CSS_VbLastDay01}>
                    {" "}
                    {VbLastDay01} Sm³
                </span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_VbLastDay01}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighVbLastDay01}
                    onChange={handleInputChangeHighVbLastDay01}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowVbLastDay01}
                    onChange={handleInputChangeLowVbLastDay01}
                    inputMode="decimal"
                />
            ),
            update: (
        ...
        {
            timeUpdate: (
                <span style={combineCss.CSS_VmLastDay01}>{timeUpdate}</span>
            ),
            name: (
                <span style={combineCss.CSS_VmLastDay01}> VM Yesterday </span>
            ),

            value: (
                <span style={combineCss.CSS_VmLastDay01}>
                    {" "}
                    {VmLastDay01} m³
                </span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_VmLastDay01}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighVmLastDay01}
                    onChange={handleInputChangeHighVmLastDay01}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowVmLastDay01}
                    onChange={handleInputChangeLowVmLastDay01}
                    inputMode="decimal"
                />
            ),
            update: (
        ...
        {
            timeUpdate: (
                <span style={combineCss.CSS_Rebattery}>{timeUpdate}</span>
            ),
            name: <span style={combineCss.CSS_Rebattery}> Remain Battery</span>,

            value: (
                <span style={combineCss.CSS_Rebattery}>
                    {" "}
                    {ReBattery01} Months{" "}
                </span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_Rebattery}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighReBattery01}
                    onChange={handleInputChangeHighReBattery01}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowReBattery01}
                    onChange={handleInputChangeLowReBattery01}
                    inputMode="decimal"
                />
            ),
            update: (
        ...
        {
            timeUpdate: (
                <span style={combineCss.CSS_Temperature}>{timeUpdate}</span>
            ),
            name: <span style={combineCss.CSS_Temperature}>Temperature </span>,

            value: (
                <span style={combineCss.CSS_Temperature}>
                    {" "}
                    {Temperature01} °C
                </span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_Temperature}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighTemperature01}
                    onChange={handleInputChangeHighTemperature01}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowTemperature01}
                    onChange={handleInputChangeLowTemperature01}
                    inputMode="decimal"
                />
            ),
            update: (
    ...
    const dataEVC02 = [
        ...
        {
            timeUpdate: (
                <span style={combineCss.CSS_VbToDay02}>{timeUpdate}</span>
            ),
            name: <span style={combineCss.CSS_VbToDay02}> VB Today</span>,

            value: (
                <span style={combineCss.CSS_VbToDay02}> {VbToDay02} Sm³</span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_VbToDay02}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighVbToDay02}
                    onChange={handleInputChangeHighVbToDay02}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowVbToDay02}
                    onChange={handleInputChangeLowVbToDay02}
                    inputMode="decimal"
                />
            ),
            update: (
        ...
        {
            timeUpdate: (
                <span style={combineCss.CSS_VmToDay02}>{timeUpdate}</span>
            ),
            name: <span style={combineCss.CSS_VmToDay02}> VM Today</span>,

            value: (
                <span style={combineCss.CSS_VmToDay02}> {VmToDay02} m³</span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_VmToDay02}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighVmToDay02}
                    onChange={handleInputChangeHighVmToDay02}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowVmToDay02}
                    onChange={handleInputChangeLowVmToDay02}
                    inputMode="decimal"
                />
            ),
            update: (
        ...
        {
            timeUpdate: (
                <span style={combineCss.CSS_VbLastDay02}>{timeUpdate}</span>
            ),
            name: <span style={combineCss.CSS_VbLastDay02}> VB Yesterday</span>,

            value: (
                <span style={combineCss.CSS_VbLastDay02}>
                    {" "}
                    {VbLastDay02} Sm³
                </span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_VbLastDay02}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighVbLastDay02}
                    onChange={handleInputChangeHighVbLastDay02}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowVbLastDay02}
                    onChange={handleInputChangeLowVbLastDay02}
                    inputMode="decimal"
                />
            ),
            update: (
        ...
        {
            timeUpdate: (
                <span style={combineCss.CSS_VmLastDay02}>{timeUpdate}</span>
            ),
            name: (
                <span style={combineCss.CSS_VmLastDay02}> VM Yesterday </span>
            ),

            value: (
                <span style={combineCss.CSS_VmLastDay02}>
                    {" "}
                    {VmLastDay02} m³
                </span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_VmLastDay02}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighVmLastDay02}
                    onChange={handleInputChangeHighVmLastDay02}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowVmLastDay02}
                    onChange={handleInputChangeLowVmLastDay02}
                    inputMode="decimal"
                />
            ),
            update: (
        ...
        {
            timeUpdate: (
                <span style={combineCss.CSS_Rebattery02}>{timeUpdate}</span>
            ),
            name: (
                <span style={combineCss.CSS_Rebattery02}> Remain Battery</span>
            ),

            value: (
                <span style={combineCss.CSS_Rebattery02}>
                    {" "}
                    {ReBattery02} Months
                </span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_Rebattery02}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighReBattery02}
                    onChange={handleInputChangeHighReBattery02}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowReBattery02}
                    onChange={handleInputChangeLowReBattery02}
                    inputMode="decimal"
                />
            ),
            update: (
        ...
        {
            timeUpdate: (
                <span style={combineCss.CSS_Temperature02}>{timeUpdate}</span>
            ),
            name: (
                <span style={combineCss.CSS_Temperature02}>Temperature </span>
            ),

            value: (
                <span style={combineCss.CSS_Temperature02}>
                    {" "}
                    {Temperature02} °C
                </span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_Temperature02}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighTemperature02}
                    onChange={handleInputChangeHighTemperature02}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowTemperature02}
                    onChange={handleInputChangeLowTemperature02}
                    inputMode="decimal"
                />
            ),
            update: (
    ...
    const dataPLC = [
        ...
        {
            timeUpdate: (
                <span style={combineCss.CSS_UpsCharging}>{timeUpdate}</span>
            ),
            name: <span style={combineCss.CSS_UpsCharging}>UPS CHARGING </span>,
            value: (
                <span style={combineCss.CSS_UpsCharging}>
                    {" "}
                    {UpsCharging} {DataCharging}
                </span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_UpsCharging}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighUpsCharging}
                    onChange={handleInputChangeHighUpsCharging}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowUpsCharging}
                    onChange={handleInputChangeLowUpsCharging}
                    inputMode="decimal"
                />
            ),
            update: (
        ...
        {
            timeUpdate: (
                <span style={combineCss.CSS_UpsBattery}>{timeUpdate}</span>
            ),
            name: <span style={combineCss.CSS_UpsBattery}>UPS BATTERY </span>,
            value: (
                <span style={combineCss.CSS_UpsBattery}>
                    {" "}
                    {UpsBattery} {DataBattery}
                </span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_UpsBattery}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighUpsBattery}
                    onChange={handleInputChangeHighUpsBattery}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowUpsBattery}
                    onChange={handleInputChangeLowUpsBattery}
                    inputMode="decimal"
                />
            ),
            update: (
        ...
        {
            timeUpdate: (
                <span style={combineCss.CSS_UpsAlarm}>{timeUpdate}</span>
            ),
            name: <span style={combineCss.CSS_UpsAlarm}>UPS ALARM </span>,
            value: (
                <span style={combineCss.CSS_UpsAlarm}>
                    {" "}
                    {UpsAlarm} {DataAlarm}
                </span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_UpsAlarm}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighUpsAlarm}
                    onChange={handleInputChangeHighUpsAlarm}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowUpsAlarm}
                    onChange={handleInputChangeLowUpsAlarm}
                    inputMode="decimal"
                />
            ),
            update: (
        ...
        {
            timeUpdate: (
                <span style={combineCss.CSS_UpsMode}>{timeUpdate}</span>
            ),
            name: <span style={combineCss.CSS_UpsMode}>UPS MODE </span>,
            value: (
                <span style={combineCss.CSS_UpsMode}>
                    {" "}
                    {UpsMode} {DataMode}
                </span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_UpsMode}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighUpsMode}
                    onChange={handleInputChangeHighUpsMode}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowUpsMode}
                    onChange={handleInputChangeLowUpsMode}
                    inputMode="decimal"
                />
            ),
            update: (
        ...
        {
            timeUpdate: (
                <span style={combineCss.CSS_SelectSW}>{timeUpdate}</span>
            ),
            name: <span style={combineCss.CSS_SelectSW}>SELECT SW </span>,
            value: (
                <span style={combineCss.CSS_SelectSW}>
                    {" "}
                    {SelectSW} {DataSelectSW}
                </span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_SelectSW}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighSelectSW}
                    onChange={handleInputChangeHighSelectSW}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowSelectSW}
                    onChange={handleInputChangeLowSelectSW}
                    inputMode="decimal"
                />
            ),
            update: (
...

        {
            ...
            value: (
                <span style={combineCss.CSS_Reset}>
                    {" "}
                    {DIReset} {DataReset}
                </span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_Reset}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighDIReset}
                    onChange={handleInputChangeHighDIReset}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowDIReset}
                    onChange={handleInputChangeLowDIReset}
                    inputMode="decimal"
                />
            ),
            update: (
        ...
        {
            timeUpdate: (
                <span style={combineCss.CSS_SELENOID}>{timeUpdate}</span>
            ),
            name: <span style={combineCss.CSS_SELENOID}>SDV-SOLENOID </span>,
            value: (
                <span style={combineCss.CSS_SELENOID}>
                    {" "}
                    {DO_SV1} {DataSV_1}
                </span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_SELENOID}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighDO_SV1}
                    onChange={handleInputChangeHighDO_SV1}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowDO_SV1}
                    onChange={handleInputChangeLowDO_SV1}
                    inputMode="decimal"
                />
            ),
            update: (
        ...
        {
            timeUpdate: (
                <span style={combineCss.CSS_EmergencyNC}>{timeUpdate}</span>
            ),
            name: <span style={combineCss.CSS_EmergencyNC}>Emergency NC </span>,
            value: (
                <span style={combineCss.CSS_EmergencyNC}>
                    {" "}
                    {EmergencyNC} {DataEmergencyNC}
                </span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_EmergencyNC}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighEmergencyNC}
                    onChange={handleInputChangeHighEmergencyNC}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowEmergencyNC}
                    onChange={handleInputChangeLowEmergencyNC}
                    inputMode="decimal"
                />
            ),
            update: (
        ...
        {
            timeUpdate: (
                <span style={combineCss.CSS_EmergencyNO}>{timeUpdate}</span>
            ),
            name: <span style={combineCss.CSS_EmergencyNO}>Emergency NO </span>,
            value: (
                <span style={combineCss.CSS_EmergencyNO}>
                    {" "}
                    {EmergencyNO} {DataEmergencyNO}
                </span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_EmergencyNO}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighEmergencyNO}
                    onChange={handleInputChangeHighEmergencyNO}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowEmergencyNO}
                    onChange={handleInputChangeLowEmergencyNO}
                    inputMode="decimal"
                />
            ),
            update: (
...

        {
            ...
            value: (
                <span style={combineCss.CSS_Horn}>
                    {" "}
                    {DOHorn} {DataHorn}
                </span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_Horn}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighDOHorn}
                    onChange={handleInputChangeHighDOHorn}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowDOHorn}
                    onChange={handleInputChangeLowDOHorn}
                    inputMode="decimal"
                />
            ),
            update: (
        ...
        },
        {
            ...
            high: (
                <InputText
                    style={combineCss.CSS_ZSC}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighZSC_1}
                    onChange={handleInputChangeHighZSC_1}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    type="number"
                    value={inputLowZSC_1}
                    onChange={handleInputChangeLowZSC_1}
                    inputMode="decimal"
                />
            ),
            update: (
...

        {
            ...
            high: (
                <InputText
                    style={combineCss.CSS_ZSO}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighZSO_1}
                    onChange={handleInputChangeHighZSO_1}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    type="number"
                    value={inputLowZSO_1}
                    onChange={handleInputChangeLowZSO_1}
                    inputMode="decimal"
                />
            ),
            update: (
...

        {
            ...
            high: (
                <InputText
                    style={combineCss.CSS_Map}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighMap}
                    onChange={handleInputChangeHighMap}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    type="number"
                    value={inputLowMap}
                    onChange={handleInputChangeLowMap}
                    inputMode="decimal"
                />
            ),
            update: (
...

        {
            ...
            value: (
                <span style={combineCss.CSS_Beacon}>
                    {" "}
                    {Beacon} {DataBeacon}
                </span>
            ),
            high: (
                <InputText
                    style={combineCss.CSS_Beacon}
                    placeholder="High"
                    step="0.1"
                    type="number"
                    value={inputHighBeacon}
                    onChange={handleInputChangeHighBeacon}
                    inputMode="decimal"
                />
            ),
            low: (
                <InputText
                    ...
                    step="0.1"
                    type="number"
                    value={inputLowBeacon}
                    onChange={handleInputChangeLowBeacon}
                    inputMode="decimal"
                />
            ),
            update: (
