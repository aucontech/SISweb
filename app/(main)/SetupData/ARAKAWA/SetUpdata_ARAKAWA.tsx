...
const ChangemaintainPLC_Conn_STT = async () => {
  ...
  const mainCategoryFC = {
    EVC: <span  style={{display:'flex',textAlign:'center', justifyContent:'space-between'  }}> EVC-1601 -  Parameter & Configuration   <div style={{display:'flex' , textAlign:'center', alignItems:'center',}}>  
        <Checkbox
        disabled={TECH_OPER}
            style={{ marginRight: 5 }}
            onChange={handleCheckboxChangeEVC}
            checked={checkMaintainingEVC}
        />
    <p style={{fontSize:15}}>Maintain EVC-1601</p>  </div>   </span> ,
    ...
    return value !== null
        ...
        const dataEVC01 = [
            ...
            value: <span style={combineCss.CSSEVC_01_Remain_Battery_Service_Life} > {formatValue(EVC_01_Remain_Battery_Service_Life)} {nameValue.month}</span> , 
             ...
             update:  <Button className='buttonUpdateSetData' onClick={confirmUpData} disabled={TECHNIAN_AUTH} label='Update' />,
             Maintain:   <Checkbox
 disabled={TECH_OPER}
...
></Checkbox>
 ...
 disabled={TECH_OPER}
     ...
     ></Checkbox>
        ...
        name: <span style={combineCss.CSSPT1}>Input Pressure PT-1603</span> ,
...
></Checkbox>
    ...
    // ];
        ...
        {
            Name: <p style={combineCssAttribute.PCV}>{namePCV_PSV.safety} (PSV-1601) (BarG)</p>,
