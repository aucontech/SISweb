...
// =================================================================================================================== 
 ...
 // =================================================================================================================== 
    ...
    const combineCss = {
        ...
        CSSRATIO_MODE : {
          ...
          const PLC01 = [
            ...
            { timeUpdate: <span style={combineCss.CSSPT_2004} >{timeUpdate}</span>,
         ...
         ></Checkbox>
            ...
            { timeUpdate: <span style={combineCss.CSSPT_2005} >{timeUpdate}</span>,
         ...
         ></Checkbox>
            ...
            { timeUpdate: <span style={combineCss.CSSTT_2003} >{timeUpdate}</span>,
        ...
        ></Checkbox>
           ...
           { timeUpdate: <span style={combineCss.CSSTT_2004} >{timeUpdate}</span>,
       ...
       ></Checkbox>
          ...
          { timeUpdate: <span style={combineCss.CSSTG_2005} >{timeUpdate}</span>,
          name: <span style={combineCss.CSSTG_2005}>TG_2005</span> ,
      ...
      ></Checkbox>
         ...
         { timeUpdate: <span style={combineCss.CSSWB_1001} >{timeUpdate}</span>,
     ...
     ></Checkbox>
        ...
        { timeUpdate: <span style={combineCss.CSSGD_2002} >{timeUpdate}</span>,
    ...
    ></Checkbox>
       ...
       { timeUpdate: <span style={combineCss.CSSGD_2003} >{timeUpdate}</span>,
   ...
   ></Checkbox>
        ...
        { timeUpdate: <span style={combineCss.CSSGD_2004} >{timeUpdate}</span>,
    ...
    ></Checkbox>
       ...
       { timeUpdate: <span style={combineCss.CSSGD_2005} >{timeUpdate}</span>,
   ...
   ></Checkbox>
      ...
      { timeUpdate: <span style={combineCss.CSSGD_2006} >{timeUpdate}</span>,
  ...
  ></Checkbox>
            ...
            { timeUpdate: <span style={combineCss.CSSTM_2002_SNG} >{timeUpdate}</span>,
           ...
           value: <span style={combineCss.CSSTM_2002_SNG} > {TM_2002_SNG}</span> , 
            high: <InputText style={combineCss.CSSTM_2002_SNG}   placeholder='High' step="0.1" type='number' value={inputValueTM_2002_SNG} onChange={handleInputChangeTM_2002_SNG} inputMode="decimal" />, 
            low:  <InputText style={combineCss.CSSTM_2002_SNG}   placeholder='Low' step="0.1" type='number' value={inputValue2TM_2002_SNG} onChange={handleInputChange2TM_2002_SNG} inputMode="decimal" />,
            update:  <button className='buttonUpdateSetData' onClick={confirmUpData} > Update </button>,
            Maintain:   <Checkbox
            style={{ marginRight: 20, }}
    ...
    { timeUpdate: <span style={combineCss.CSSTM_2003_SNG} >{timeUpdate}</span>,
   ...
   value: <span style={combineCss.CSSTM_2003_SNG} > {TM_2003_SNG}</span> , 
    high: <InputText style={combineCss.CSSTM_2003_SNG}   placeholder='High' step="0.1" type='number' value={inputValueTM_2003_SNG} onChange={handleInputChangeTM_2003_SNG} inputMode="decimal" />, 
    low:  <InputText style={combineCss.CSSTM_2003_SNG}   placeholder='Low' step="0.1" type='number' value={inputValue2TM_2003_SNG} onChange={handleInputChange2TM_2003_SNG} inputMode="decimal" />,
    update:  <button className='buttonUpdateSetData' onClick={confirmUpData} > Update </button>,
    Maintain:   <Checkbox
    style={{ marginRight: 20, }}
...
></Checkbox>
  ...
  { timeUpdate: <span style={combineCss.CSSSDV_2004} >{timeUpdate}</span>,
  name: <span style={combineCss.CSSSDV_2004}>Shutdown Valve SDV-2004</span> ,

  modbus: <span style={combineCss.CSSSDV_2004}>40029	 </span> ,

 value: <span style={combineCss.CSSSDV_2004} > {SDV_2004}</span> , 
  high: <InputText style={combineCss.CSSSDV_2004}   placeholder='High' step="0.1" type='number' value={inputValueSDV_2004} onChange={handleInputChangeSDV_2004} inputMode="decimal" />, 
  low:  <InputText style={combineCss.CSSSDV_2004}   placeholder='Low' step="0.1" type='number' value={inputValue2SDV_2004} onChange={handleInputChange2SDV_2004} inputMode="decimal" />,
  update:  <button className='buttonUpdateSetData' onClick={confirmUpData} > Update </button>,
  Maintain:   <Checkbox
  style={{ marginRight: 20, }}
...
></Checkbox>
 ...
 { timeUpdate: <span style={combineCss.CSSSDV_2003} >{timeUpdate}</span>,
   name: <span style={combineCss.CSSSDV_2003}>Shutdown Valve SDV-2003</span> ,

   modbus: <span style={combineCss.CSSSDV_2003}>40031	 </span> ,

  value: <span style={combineCss.CSSSDV_2003} > {SDV_2003}</span> , 
   high: <InputText style={combineCss.CSSSDV_2003}   placeholder='High' step="0.1" type='number' value={inputValueSDV_2003} onChange={handleInputChangeSDV_2003} inputMode="decimal" />, 
   low:  <InputText style={combineCss.CSSSDV_2003}   placeholder='Low' step="0.1" type='number' value={inputValue2SDV_2003} onChange={handleInputChange2SDV_2003} inputMode="decimal" />,
   update:  <button className='buttonUpdateSetData' onClick={confirmUpData} > Update </button>,
   Maintain:   <Checkbox
   style={{ marginRight: 20, }}
...
></Checkbox>
       ...
       ></Checkbox>
         ...
         { timeUpdate: <span style={combineCss.CSSFCV_2001} >{timeUpdate}</span>,
   ...
   ></Checkbox>
      ...
      { timeUpdate: <span style={combineCss.CSSHV_1001} >{timeUpdate}</span>,
...
></Checkbox>
   ...
   { timeUpdate: <span style={combineCss.CSSTM2002_CNG} >{timeUpdate}</span>,
  ...
  value: <span style={combineCss.CSSTM2002_CNG} > {TM2002_CNG}</span> , 
   high: <InputText style={combineCss.CSSTM2002_CNG}   placeholder='High' step="0.1" type='number' value={inputValueTM2002_CNG} onChange={handleInputChangeTM2002_CNG} inputMode="decimal" />, 
   low:  <InputText style={combineCss.CSSTM2002_CNG}   placeholder='Low' step="0.1" type='number' value={inputValue2TM2002_CNG} onChange={handleInputChange2TM2002_CNG} inputMode="decimal" />,
   update:  <button className='buttonUpdateSetData' onClick={confirmUpData} > Update </button>,
   Maintain:   <Checkbox
   style={{ marginRight: 20, }}
...
></Checkbox>
  ...
  { timeUpdate: <span style={combineCss.CSSTM2003_CNG} >{timeUpdate}</span>,
 ...
 value: <span style={combineCss.CSSTM2003_CNG} > {TM2003_CNG}</span> , 
  high: <InputText style={combineCss.CSSTM2003_CNG}   placeholder='High' step="0.1" type='number' value={inputValueTM2003_CNG} onChange={handleInputChangeTM2003_CNG} inputMode="decimal" />, 
  low:  <InputText style={combineCss.CSSTM2003_CNG}   placeholder='Low' step="0.1" type='number' value={inputValue2TM2003_CNG} onChange={handleInputChange2TM2003_CNG} inputMode="decimal" />,
  update:  <button className='buttonUpdateSetData' onClick={confirmUpData} > Update </button>,
  Maintain:   <Checkbox
  style={{ marginRight: 20, }}
