...
const ChangeMaintainPLC_Conn_STT = async () => {
  ...
  const mainCategoryFC = {
    FC01: <span  style={{display:'flex',textAlign:'center', justifyContent:'space-between'  }}> FC-1401 -  Parameters & Configurations <div style={{display:'flex' , textAlign:'center', alignItems:'center',}}>  
        <Checkbox
                disabled={TECH_OPER}
            style={{ marginRight: 5 }}
...
const formatValue = (value:any) => {
    return value !== null
       ...
       value: <span style={combineCss.CSSFC_01_Current_Values_Static_Pressure} > {formatValue(FC_01_Current_Values_Static_Pressure)} {nameValue.Bara}</span> , 
        ...
        update:  <Button className='buttonUpdateSetData' onClick={confirmUpData} label='Update' disabled={TECH_OPER} />,
        Maintain:   <Checkbox
                disabled={TECH_OPER}
