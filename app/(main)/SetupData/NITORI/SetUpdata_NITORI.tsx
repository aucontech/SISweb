...
//===========================================================================================
  ...
  const mainCategoryFC = {
    EVC: <span  style={{display:'flex',textAlign:'center', justifyContent:'space-between'  }}> EVC-1301 -  Parameter & Configuration <div style={{display:'flex' , textAlign:'center', alignItems:'center',}}>  
