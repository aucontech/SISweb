...
export default function BallValueSDV_2() {
        ...
        if (ws.current) {
            ws.current.onmessage = (event) => {
                ...
                if (dataReceived.data && dataReceived.data.data.length > 0) {
                    const ballValue =
                        dataReceived.data.data[0].latest.ATTRIBUTE.BallValueSDV_2
                            .value;
                    setUpData(ballValue);
                    ...
                    const updatedData =
                        dataReceived.update[0].latest.ATTRIBUTE.BallValueSDV_2
                            .value;
                    const updateTS =
                        dataReceived.update[0].latest.ATTRIBUTE.BallValueSDV_2.ts;
    ...
    const handleButtonClick = async () => {
        ...
        const fetchData = async () => {
            try {
                ...
                setData(res.data);
                const ballValue = res.data.find((item: any) => item.key === "BallValueSDV_2")?.value;
