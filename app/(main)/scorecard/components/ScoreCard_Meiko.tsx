    ...
    const tagNamePLC = {
        ...
        const DataSDV_302  = SDV_302 === "0" ? "Off" : SDV_302 === "1" ? "On" : null;
            ...
            const combineCss = {
                ...
                SDV2: { x: -1127.2804525595525, y: 948.8166088808405 },
                SDV_Ball2: { x: -1082.1826908317034, y: 1163.7430466784738 },
                SDV_IMG2: { x: -1105.7858651854403, y: 995.2834321094119 },
                SDV_Name_none2: { x: -1249.6461839977737, y: 902.8410000476873 },
                SDV_None2: { x: -1079.6286470234306, y: 1045.6886789070904 },
