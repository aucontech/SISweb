...
if (!isNaN(PLC_Conn_STTValue) && !isNaN(highValue) && !isNaN(lowValue) && !maintainPLC_Conn_STT) {
 setexceedThresholdPLC_Conn_STT(PLC_Conn_STTValue >= highValue || PLC_Conn_STTValue <= lowValue);
    ...
    const tagNameEVC = {
        ...
        EVC_01_Conn_STT: "EVC-2001A Connection Status (0: Not Init - 1: COM OK - 2: Error)",
        EVC_02_Conn_STT: "EVC-2001B Connection Status (0: Not Init - 1: COM OK - 2: Error)",
    ...
    CSSEVC_02_Vm_of_Last_Day : {
        ...
        },
        {
            ...
            PLC: <span style={combineCss.CSSPIT_2007}>{} {formatValue(PIT_2007)}</span>,
        },
        {
            name: <span>{tagNamePLC.PT_2001}</span>,
            PLC: <span style={combineCss.CSSPT_2001}> {formatValue(PT_2001)}</span>,
        },
        {
            name: <span>{tagNamePLC.PT_2002}</span>,
            PLC: <span style={combineCss.CSSPT_2002}> {formatValue(PT_2002)}</span>,
        },
        {
