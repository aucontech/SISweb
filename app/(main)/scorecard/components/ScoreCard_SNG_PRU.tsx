...
import { id_SNG, id_OTSUKA } from "../../data-table-device/ID-DEVICE/IdDevice";
            ...
            ws.current.onmessage = (evt) => {
                ...
                if (dataReceived.update !== null) {
                    ...
                    const valueStateMap: ValueStateMap = {
                        Calorific_Calorimeter: setConn_STTValue,
                    };
                    keys.forEach((key) => {
                        if (stateMap[key]) {
...
// =================================================================================================================== 
    ...
    const tagNamePLC = {
        ...
        TM_2002_CNG: "Tubine Meter TM2002-CNG (Sm³/h)",
        TM_2003_CNG: "Tubine Meter TM2003-CNG (Sm³/h)",
        WB_Setpoint: "Wobbe Index Setpoint (MJ/Sm³)",
        WIS_Calorimeter: "WIS Calorimeter (kcal/Nm³)", 
        Calorific_Calorimeter: "Calorific Calorimeter (kcal/Nm³)",
        Specific_Calorimeter: "Specific Calorimeter",
        ...
        CSSTM_2002_CNG : {
            ...
            ? "orange"
            : "" ,
            fontWeight: (exceedThresholdTM_2002_CNG || maintainTM_2002_CNG)
            ? 600
            : "",
            fontSize: (exceedThresholdTM_2002_CNG || maintainTM_2002_CNG)
            ? 18
            : ""
        },
        ...
        CSSTM_2003_CNG : {
            ...
            ? "orange"
            : "" ,
            fontWeight: (exceedThresholdTM_2003_CNG || maintainTM_2003_CNG)
            ? 600
            : "",
            fontSize: (exceedThresholdTM_2003_CNG || maintainTM_2003_CNG)
            ? 18
            : ""
        },
        ...
        CSSCalorific_Calorimeter : {
            ...
            ? "orange"
            : "" ,
            fontWeight: (exceedThresholdCalorific_Calorimeter || maintainCalorific_Calorimeter)
            ? 600
            : "",
            fontSize: (exceedThresholdCalorific_Calorimeter || maintainCalorific_Calorimeter)
            ? 18
            : ""
        },
        ...
        CSSSpecific_Calorimeter : {
            ...
            ? "orange"
            : "" ,
            fontWeight: (exceedThresholdSpecific_Calorimeter || maintainSpecific_Calorimeter)
            ? 600
            : "",
            fontSize: (exceedThresholdSpecific_Calorimeter || maintainSpecific_Calorimeter)
            ? 18
            : ""
        },
