...
const ScoreCard = () => {
    ...
    const stationList: StationListType = {
      ...
      "Pasir Gudang CG": <ScoreCard_ZOCV />,
      Melaka: <ScoreCard_KOA />,
      "Kota Kinabalu": <ScoreCard_Nitori />,
      Selangor: <ScoreCard_Yoshino />,
      Sabah: <ScoreCard_IGUACU />,
      Penang: <ScoreCard_Arakawa />,
      Johor: <ScoreCard_SPMCV />,
      Perlis: <ScoreCard_VREC />,
