...
export default function PSV02_Otsuka() {
        ...
        if (ws.current) {
            ws.current.onmessage = (event) => {
                ...
                if (dataReceived.data && dataReceived.data.data.length > 0) {
                    const ballValue =
                        dataReceived.data.data[0].latest.ATTRIBUTE.PSV_02
                            .value;
                    setUpData(ballValue);
                    ...
                    const updatedData =
                        dataReceived.update[0].latest.ATTRIBUTE.PSV_02
                            .value;
                    const updateTS =
                        dataReceived.update[0].latest.ATTRIBUTE.PSV_02.ts;
    ...
    return (
        <div>
            ...
            <Button style={{border:'none', }} onClick={handleButtonToggle}>     PSV - {upData}</Button>
            <OverlayPanel ref={op}>
                <div>
