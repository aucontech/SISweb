...
// ========================== GVA2- FIQ-1901 ============================================
    ...
    return (
        ...
        <table style={{ borderCollapse: 'collapse', width: '100%', borderRadius:5,  }}>
            <tbody style={{borderRadius:10, }}>
                <tr style={{width:'20%', marginBottom:20}}>
                    <td style={{  fontSize:20, fontWeight:500 }}>Name</td>
                    <td style={{  fontSize:20, fontWeight:500 }}>Value</td>
                    <td style={{  fontSize:20, fontWeight:500 }}>High</td>
                    <td style={{  fontSize:20, fontWeight:500 }}>Low</td>
                    <td style={{  fontSize:20, fontWeight:500 }}>Update</td>
                </tr>
                <br />
                <tr style={{ backgroundColor: exceedThreshold ? '#ff5656' : '#fff',width:'100%', fontWeight:600, color:'#036E9B' }} >
                    ...
                    <td  style={{  width:'20%' }}>
                        <InputText className="p-inputtext-sm" placeholder='Low' step="0.1" type='number' value={inputValue2} onChange={handleInputChange2} inputMode="decimal" />
                    </td>
                    <td  style={{  width:'20%' }}>
                ...
                <tr style={{ backgroundColor: exceedThreshold2 ? '#ff5656' : '#fff', fontWeight:600, color:''  }} >
                    ...
                    <td  style={{   }}>
                        <InputText className="p-inputtext-sm" placeholder='Low' step="0.1" type='number' value={inputValueEK1Low} onChange={handleInputChangeEK2Low} inputMode="decimal" />
                    </td>
                    <td  style={{   }}>
                                 <Button label="Update"  onClick={handleButtonClick} />
                ...
                <tr style={{ backgroundColor: exceedThreshold3 ? '#ff5656' : '#fff', fontWeight:600, color:''  }} >
                    ...
                    <td  style={{   }}>
                        <InputText className="p-inputtext-sm" placeholder='Low' step="0.1" type='number' value={inputValueEK3Low} onChange={handleInputChangeEK3Low} inputMode="decimal" />
                    </td>
                    <td  style={{   }}>
                                 <Button label="Update"  onClick={handleButtonClick} />
                ...
                <div style={{height:3}}></div>
                <tr style={{ backgroundColor: AlarmGD01 ? '#ff5656' : '#fff', fontWeight:600, color:''  }} >
                    
                    <td  style={{   color: AlarmGD01 ? 'white' : '#036E9B' }}>GD-1901</td>
                    <td  style={{  color: AlarmGD01 ? 'white' : '#036E9B'}}>{GD01} LEL</td>
                    <td  style={{   }}>
                        <InputText className="p-inputtext-sm" placeholder='High' step="0.1" type='number' value={inputHighGD01} onChange={handleInputChangeHighGD01} inputMode="decimal" />
                    </td>
                    <td  style={{   }}>
                        <InputText className="p-inputtext-sm" placeholder='Low' step="0.1" type='number' value={inputLowGD01} onChange={handleInputChangeLowGD01} inputMode="decimal" />
                    </td>
                    <td  style={{   }}>
                                 <Button label="Update"  onClick={handleButtonClick} />
                ...
                <div style={{height:3}}></div>
                <tr style={{ backgroundColor: AlarmGD02 ? '#ff5656' : '#fff', fontWeight:600, color:''  }} >
                    
                    <td  style={{   color: AlarmGD02 ? 'white' : '#036E9B' }}>GD-1902</td>
                    <td  style={{  color: AlarmGD02 ? 'white' : '#036E9B' }}>{GD02} LEL</td>
                    <td  style={{   }}>
                        <InputText className="p-inputtext-sm"  placeholder='High' step="0.1" type='number' value={inputHighGD02} onChange={handleInputChangeHighGD02} inputMode="decimal" />
                    </td>
                    <td  style={{   }}>
                        <InputText className="p-inputtext-sm" placeholder='Low' step="0.1" type='number' value={inputLowGD02} onChange={handleInputChangeLowGD02} inputMode="decimal" />
                    </td>
                    <td  style={{   }}>
                                 <Button label="Update"  onClick={handleButtonClick} />
                ...
                <div style={{height:3}}></div>
                <tr style={{ backgroundColor: AlarmGD03 ? '#ff5656' : '#fff', fontWeight:600, color:''  }} >
                    
                    <td  style={{   color: AlarmGD03 ? 'white' : '#036E9B' }}>GD-1903</td>
                    <td  style={{  color: AlarmGD03 ? 'white' : '#036E9B' }}>{GD03} LEL </td>
                    <td  style={{   }}>
                        <InputText className="p-inputtext-sm" placeholder='High' step="0.1" type='number' value={inputHighGD03} onChange={handleInputChangeHighGD03} inputMode="decimal" />
                    </td>
                    <td  style={{   }}>
                        <InputText className="p-inputtext-sm" placeholder='Low' step="0.1" type='number' value={inputLowGD03} onChange={handleInputChangeLowGD03} inputMode="decimal" />
                    </td>
                    <td  style={{   }}>
                                 <Button label="Update"  onClick={handleButtonClick} />
                ...
                <tr style={{ backgroundColor: AlarmGVF1 ? '#ff5656' : '#fff', fontWeight:600, color:''  }} >
                    
                    <td  style={{   color: AlarmGVF1 ? 'white' : 'black' }}>GVF FIQ-1901</td>
                    <td  style={{  color: AlarmGVF1 ? 'white' : 'black' }}>{GVF1} sm³/h </td>
                    <td  style={{   }}>
                        <InputText className="p-inputtext-sm" placeholder='High' step="0.1" type='number' value={inputHighGVF1} onChange={handleInputChangeHighGVF1} inputMode="decimal" />
                    </td>
                    <td  style={{   }}>
                        <InputText className="p-inputtext-sm" placeholder='Low' step="0.1" type='number' value={inputLowGVF1} onChange={handleInputChangeLowGVF1} inputMode="decimal" />
                    </td>
                    <td  style={{   }}>
                                 <Button label="Update"  onClick={handleButtonClick} />
                ...
                <tr style={{ backgroundColor: AlarmSVF1 ? '#ff5656' : '#fff', fontWeight:600, color:''  }} >
                    
                    <td  style={{   color: AlarmSVF1 ? 'white' : 'black' }}>SVF FIQ-1901</td>
                    <td  style={{  color: AlarmSVF1 ? 'white' : 'black'}}>{SVF1} m³/h</td>
                    <td  style={{   }}>
                        <InputText className="p-inputtext-sm" placeholder='High' step="0.1" type='number' value={inputHighSVF1} onChange={handleInputChangeHighSVF1} inputMode="decimal" />
                    </td>
                    <td  style={{   }}>
                        <InputText className="p-inputtext-sm" placeholder='Low' step="0.1" type='number' value={inputLowSVF1} onChange={handleInputChangeLowSVF1} inputMode="decimal" />
                    </td>
                    <td  style={{   }}>
                                 <Button label="Update"  onClick={handleButtonClick} />
                ...
                <tr style={{ backgroundColor: AlarmSVA1 ? '#ff5656' : '#fff', fontWeight:600,  }} >
                    ...
                    <td  style={{   }}>
                        <InputText className="p-inputtext-sm" placeholder='Low' step="0.1" type='number' value={inputLowSVA1} onChange={handleInputChangeLowSVA1} inputMode="decimal" />
                    </td>
                    <td  style={{   }}>
                                 <Button label="Update"  onClick={handleButtonClick} />
                ...
                <tr style={{ backgroundColor: AlarmGVA1 ? '#ff5656' : '#fff', fontWeight:600,  }} >
                    
                    <td  style={{   color: AlarmGVA1 ? 'white' : 'black', }}>GVA FIQ-1901</td>
                    <td  style={{  color: AlarmGVA1 ? 'white' : 'black', }}>{GVA1} m³</td>
                    <td  style={{   }}>
                        <InputText className="p-inputtext-sm" placeholder='High' step="0.1" type='number' value={inputHighGVA1} onChange={handleInputChangeHighGVA1} inputMode="decimal" />
                    </td>
                    <td  style={{   }}>
                        <InputText className="p-inputtext-sm" placeholder='Low' step="0.1" type='number' value={inputLowGVA1} onChange={handleInputChangeLowGVA1} inputMode="decimal" />
                    </td>
                    <td  style={{   }}>
                                 <Button label="Update"  onClick={handleButtonClick} />
...
<tr style={{ backgroundColor: AlarmGVF2 ? '#ff5656' : '#fff', fontWeight:600, color:''  }} >
    
    <td  style={{   color: AlarmGVF2 ? 'white' : '#CC6600' }}>GVF FIQ-1902</td>
    <td  style={{  color: AlarmGVF2 ? 'white' : '#CC6600' }}>{GVF2} sm³/h </td>
    <td  style={{   }}>
        <InputText className="p-inputtext-sm" placeholder='High' step="0.1" type='number' value={inputHighGVF2} onChange={handleInputChangeHighGVF2} inputMode="decimal" />
    </td>
    <td  style={{   }}>
        <InputText className="p-inputtext-sm" placeholder='Low' step="0.1" type='number' value={inputLowGVF2} onChange={handleInputChangeLowGVF2} inputMode="decimal" />
    </td>
    <td  style={{   }}>
                 <Button label="Update"  onClick={handleButtonClick} />
...
<tr style={{ backgroundColor: AlarmSVF2 ? '#ff5656' : '#fff', fontWeight:600, color:''  }} >
    
    <td  style={{   color: AlarmSVF2 ? 'white' : '#CC6600' }}>SVF FIQ-1902</td>
    <td  style={{  color: AlarmSVF2 ? 'white' : '#CC6600' }}>{SVF2} m³/h</td>
    <td  style={{   }}>
        <InputText className="p-inputtext-sm" placeholder='High' step="0.1" type='number' value={inputHighSVF2} onChange={handleInputChangeHighSVF2} inputMode="decimal" />
    </td>
    <td  style={{   }}>
        <InputText className="p-inputtext-sm" placeholder='Low' step="0.1" type='number' value={inputLowSVF2} onChange={handleInputChangeLowSVF2} inputMode="decimal" />
    </td>
    <td  style={{   }}>
                 <Button label="Update"  onClick={handleButtonClick} />
...
<tr style={{ backgroundColor: AlarmSVA2 ? '#ff5656' : '#fff', fontWeight:600,  }} >
    ...
    <td  style={{   }}>
        <InputText className="p-inputtext-sm" placeholder='Low' step="0.1" type='number' value={inputLowSVA2} onChange={handleInputChangeLowSVA2} inputMode="decimal" />
    </td>
    <td  style={{   }}>
                 <Button label="Update"  onClick={handleButtonClick} />
...
<tr style={{ backgroundColor: AlarmGVA2 ? '#ff5656' : '#fff', fontWeight:600,  }} >
    
    <td  style={{   color: AlarmGVA2 ? 'white' : '#CC6600', }}>GVA FIQ-1902</td>
    <td  style={{  color: AlarmGVA2 ? 'white' : '#CC6600', }}>{GVA2} m³</td>
    <td  style={{   }}>
        <InputText className="p-inputtext-sm" placeholder='High' step="0.1" type='number' value={inputHighGVA2} onChange={handleInputChangeHighGVA2} inputMode="decimal" />
    </td>
    <td  style={{   }}>
        <InputText className="p-inputtext-sm" placeholder='Low' step="0.1" type='number' value={inputLowGVA2} onChange={handleInputChangeLowGVA2} inputMode="decimal" />
    </td>
    <td  style={{   }}>
                 <Button label="Update"  onClick={handleButtonClick} />
