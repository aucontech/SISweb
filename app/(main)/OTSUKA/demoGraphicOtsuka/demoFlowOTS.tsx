            ...
            if (node.id === "data4") {
                ...
                EVC_01_Flow_at_Base_Condition !== null
                    ? new Intl.NumberFormat('en-US', {
                      ...
                      }).format(parseFloat(EVC_01_Flow_at_Base_Condition.toString()))
                    : "";
                return {
                    ...node,
                    data: {
            ...
            if (node.id === "data3") {
                ...
                EVC_01_Flow_at_Measurement_Condition !== null
                    ? new Intl.NumberFormat('en-US', {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2
                      }).format(parseFloat(EVC_01_Flow_at_Measurement_Condition.toString()))
                    : "";
                return {
                    ...node,
                    data: {
            ...
            if (node.id === "data2") {
                ...
                EVC_01_Volume_at_Base_Condition !== null
                    ? new Intl.NumberFormat('en-US', {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2
                      }).format(parseFloat(EVC_01_Volume_at_Base_Condition.toString()))
                    : "";
            ...
            if (node.id === "data1") {
                ...
                EVC_01_Volume_at_Measurement_Condition !== null
                    ? new Intl.NumberFormat('en-US', {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2
                      }).format(parseFloat(EVC_01_Volume_at_Measurement_Condition.toString()))
                    : "";
            ...
            if (node.id === "data5") {
                ...
                EVC_02_Flow_at_Base_Condition !== null
                    ? new Intl.NumberFormat('en-US', {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2
                      }).format(parseFloat(EVC_02_Flow_at_Base_Condition.toString()))
                    : "";
...
EVC_02_Flow_at_Measurement_Condition !== null
    ? new Intl.NumberFormat('en-US', {
          minimumFractionDigits: 2,
          maximumFractionDigits: 2
      }).format(parseFloat(EVC_02_Flow_at_Measurement_Condition.toString()))
    : "";
            ...
            if (node.id === "data7") {
                ...
                EVC_02_Volume_at_Base_Condition !== null
                    ? new Intl.NumberFormat('en-US', {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2
                      }).format(parseFloat(EVC_02_Volume_at_Base_Condition.toString()))
                    : "";
            ...
            if (node.id === "data8") {
                ...
                EVC_02_Volume_at_Measurement_Condition !== null
                    ? new Intl.NumberFormat('en-US', {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2
                      }).format(parseFloat(EVC_02_Volume_at_Measurement_Condition.toString()))
                    : "";
    ...
    //     : {
              ...
              PCV02: { x: -634.4409855174947, y: 1122.0289470895134 },
              PCV_NONE1: { x: -618.5302651241782, y: 925.4012928867226 },
              PCV_NONE2: { x: -618.0764144687789, y: 1167.3419652432742 },
