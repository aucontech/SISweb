...
export default function Graphic_CNG_HUNGYEN() {
    ...
    const initialPositions = {
        ...
        PCV_3002A_DATA: { x: -1648.4407513108924, y: 980.9864265861706 },
        PCV_3002B_DATA: { x: -1650.4202186554123, y: 1389.6028607942028 },
