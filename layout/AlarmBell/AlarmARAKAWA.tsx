...
// import { id_ARAKAWA } from "@/app/(main)/data-table-device/ID-DEVICE/IdDevice";

// export default function AlarmARAKAWA() {
...
export default function AlarmARAKAWA() {
  ...
  return (
    <div>
      ...
      {/* Show the second div if showMore is true */}
      {showMore ? <div>AlarmARAKAWA</div> :
        <div>
          AlarmARAKAWA
          AAAAA
        </div>
